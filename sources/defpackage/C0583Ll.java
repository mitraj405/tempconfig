...
public final class C0583Ll implements DialogInterface.OnClickListener {
    public final /* synthetic */ C1480xl.f.a a;

    public C0583Ll(C1480xl.f.a aVar) {
        this.a = aVar;
    }
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        ...
        if (C1480xl.this.f7046c != null) {
            C0535I5.W(fVar.f7055a.getString(R.string.some_error_occurred_please_try_again), false, new C0822cf(C1480xl.f.this.f7055a.getActivity()), (String) null, (String) null);
        }
