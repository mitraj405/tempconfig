...
public final class C0644Pt implements Interceptor {
    public final Response intercept(Interceptor.Chain chain) throws IOException {
        try {
            ...
            Request.Builder header = request.newBuilder().header("greq", IrctcImaApplication.c).header(HttpHeaders.USER_AGENT, str.concat("4.2.28Android")).header("bmirak", "androidbm").header("bmiyek", Bw.e(IrctcImaApplication.a).f3534a.getString("sdflkjl", "")).header("mup", IrctcImaApplication.d);
