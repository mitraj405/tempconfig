...
public final class C1118fs {
    ...
    public static final int[] BaseProgressIndicator = {16843065, R.attr.hideAnimationBehavior, R.attr.indicatorColor, R.attr.indicatorTrackGapSize, R.attr.minHideDelay, R.attr.showAnimationBehavior, R.attr.showDelay, R.attr.trackColor, R.attr.trackCornerRadius, R.attr.trackThickness};
    ...
    public static final int[] MKActionBar = {R.attr.actionBarBackgroundColor, R.attr.backNavigation, R.attr.isTitleIcon, R.attr.menuIcon1, R.attr.menuIcon2, R.attr.menuIcon3, R.attr.menuIcon4, R.attr.menuIcon5, R.attr.menuTextColor, R.attr.showNotifCount, R.attr.titleString, R.attr.typeTitle};
    public static final int MKActionBar_actionBarBackgroundColor = 0;
    public static final int MKActionBar_backNavigation = 1;
    public static final int MKActionBar_isTitleIcon = 2;
    public static final int MKActionBar_menuIcon1 = 3;
    public static final int MKActionBar_menuIcon2 = 4;
    public static final int MKActionBar_menuIcon3 = 5;
    public static final int MKActionBar_menuIcon4 = 6;
    public static final int MKActionBar_menuIcon5 = 7;
    public static final int MKActionBar_menuTextColor = 8;
    public static final int MKActionBar_showNotifCount = 9;
    public static final int MKActionBar_titleString = 10;
    public static final int MKActionBar_typeTitle = 11;
    public static final int[] MKButton = {R.attr.button_background, R.attr.button_text, R.attr.button_text_color_state};
    public static final int MKButton_button_background = 0;
    public static final int MKButton_button_text = 1;
    public static final int MKButton_button_text_color_state = 2;
    public static final int[] MKCheckBox = {R.attr.background_color, R.attr.checkbox_enabled, R.attr.checkbox_label_size, R.attr.checkbox_size, R.attr.checked, R.attr.clickable, R.attr.darkThemeCheckbox, R.attr.disabled_color, R.attr.icon_color, R.attr.icon_selected_color, R.attr.label_text, R.attr.right_align, R.attr.text_color, R.attr.text_selected_color, R.attr.use_bold_label};
    public static final int MKCheckBox_background_color = 0;
    public static final int MKCheckBox_checkbox_enabled = 1;
    public static final int MKCheckBox_checkbox_label_size = 2;
    public static final int MKCheckBox_checkbox_size = 3;
    public static final int MKCheckBox_checked = 4;
    public static final int MKCheckBox_clickable = 5;
    public static final int MKCheckBox_darkThemeCheckbox = 6;
    public static final int MKCheckBox_disabled_color = 7;
    public static final int MKCheckBox_icon_color = 8;
    public static final int MKCheckBox_icon_selected_color = 9;
    public static final int MKCheckBox_label_text = 10;
    public static final int MKCheckBox_right_align = 11;
    public static final int MKCheckBox_text_color = 12;
    public static final int MKCheckBox_text_selected_color = 13;
    public static final int MKCheckBox_use_bold_label = 14;
    public static final int[] MKCommonButton = {R.attr.button_text};
    public static final int MKCommonButton_button_text = 0;
    public static final int[] MKEditText = {R.attr.activeColor, R.attr.backgroundColor, R.attr.bigEditText, R.attr.bottomSeparator, R.attr.creditCardFormat, R.attr.darkTheme, R.attr.digits, R.attr.disabledColor, R.attr.enabled, R.attr.errorColor, R.attr.errorText, R.attr.extraHint, R.attr.highlightColor, R.attr.hint, R.attr.hintTextColor, R.attr.iconText, R.attr.iconTextColor, R.attr.iconTextSize, R.attr.imeOptions, R.attr.inputType, R.attr.isTouchEnabled, R.attr.isUsedForHalf, R.attr.labelText, R.attr.labelTextSize, R.attr.maxLength, R.attr.password, R.attr.selectAllOnFocus, R.attr.separatorColor, R.attr.showError, R.attr.showIcon, R.attr.showLabel, R.attr.showValue, R.attr.singleLine, R.attr.text, R.attr.textColor, R.attr.textSize, R.attr.topSeparator};
    public static final int MKEditText_activeColor = 0;
    public static final int MKEditText_backgroundColor = 1;
    public static final int MKEditText_bigEditText = 2;
    public static final int MKEditText_bottomSeparator = 3;
    public static final int MKEditText_creditCardFormat = 4;
    public static final int MKEditText_darkTheme = 5;
    public static final int MKEditText_digits = 6;
    public static final int MKEditText_disabledColor = 7;
    public static final int MKEditText_enabled = 8;
    public static final int MKEditText_errorColor = 9;
    public static final int MKEditText_errorText = 10;
    public static final int MKEditText_extraHint = 11;
    public static final int MKEditText_highlightColor = 12;
    public static final int MKEditText_hint = 13;
    public static final int MKEditText_hintTextColor = 14;
    public static final int MKEditText_iconText = 15;
    public static final int MKEditText_iconTextColor = 16;
    public static final int MKEditText_iconTextSize = 17;
    public static final int MKEditText_imeOptions = 18;
    public static final int MKEditText_inputType = 19;
    public static final int MKEditText_isTouchEnabled = 20;
    public static final int MKEditText_isUsedForHalf = 21;
    public static final int MKEditText_labelText = 22;
    public static final int MKEditText_labelTextSize = 23;
    public static final int MKEditText_maxLength = 24;
    public static final int MKEditText_password = 25;
    public static final int MKEditText_selectAllOnFocus = 26;
    public static final int MKEditText_separatorColor = 27;
    public static final int MKEditText_showError = 28;
    public static final int MKEditText_showIcon = 29;
    public static final int MKEditText_showLabel = 30;
    public static final int MKEditText_showValue = 31;
    public static final int MKEditText_singleLine = 32;
    public static final int MKEditText_text = 33;
    public static final int MKEditText_textColor = 34;
    public static final int MKEditText_textSize = 35;
    public static final int MKEditText_topSeparator = 36;
    public static final int[] MKSpinner = {R.attr.entries, R.attr.is_grid, R.attr.mks_prompt};
    public static final int MKSpinner_entries = 0;
    public static final int MKSpinner_is_grid = 1;
    public static final int MKSpinner_mks_prompt = 2;
