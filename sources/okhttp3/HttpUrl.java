...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public Builder parse(HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl2 == null || !httpUrl2.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    if (c == c2 || c == c4 || c == '/' || c == '\\' || c == c3) {
                        int portColonOffset = portColonOffset(str2, i, delimiterOffset);
                        ...
                        if (c == '@') {
                            if (!z) {
                                ...
                                boolean z3 = z;
                                String str3 = "%40";
                                String canonicalize = HttpUrl.canonicalize(str, i, delimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                if (z2) {
                                    canonicalize = C1058d.B(new StringBuilder(), this.encodedUsername, str3, canonicalize);
                                }
                                this.encodedUsername = canonicalize;
                                if (i3 != delimiterOffset) {
                                    this.encodedPassword = HttpUrl.canonicalize(str, i3 + 1, delimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                    z = true;
                                } else {
                                    z = z3;
                                }
                                ...
                                this.encodedPassword += "%40" + HttpUrl.canonicalize(str, i, delimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                z = z;
                            }
                            i = delimiterOffset + 1;
                        }
                ...
                int portColonOffset2 = portColonOffset(str2, i, delimiterOffset);
                int i22 = portColonOffset2 + 1;
                if (i22 < delimiterOffset) {
                    this.host = canonicalizeHost(str2, i, portColonOffset2);
                    int parsePort = parsePort(str2, i22, delimiterOffset);
                    this.port = parsePort;
                    if (parsePort == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str2.substring(i22, delimiterOffset) + '\"');
                    }
                } else {
                    this.host = canonicalizeHost(str2, i, portColonOffset2);
                ...
                if (this.host != null) {
                    ...
                    throw new IllegalArgumentException("Invalid URL host: \"" + str2.substring(i, portColonOffset2) + '\"');
                }
            } else {
            ...
            if (delimiterOffset3 < skipTrailingAsciiWhitespace && str2.charAt(delimiterOffset3) == '#') {
                this.encodedFragment = HttpUrl.canonicalize(str, delimiterOffset3 + 1, skipTrailingAsciiWhitespace, "", true, false, false, false, (Charset) null);
            }
            return this;
        }
        ...
        public Builder port(int i) {
            if (i <= 0 || i > 65535) {
                throw new IllegalArgumentException(lf.h("unexpected port: ", i));
            }
            this.port = i;
            return this;
        }
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    if (charset == null || charset.equals(StandardCharsets.UTF_8)) {
                        ...
                        buffer2.N(str, i, Character.charCount(codePointAt) + i, charset);
                    }
                    while (!buffer2.h0()) {
        ...
        while (i < i2) {
            ...
            if (codePointAt == 37 && (i3 = i + 2) < i2) {
                ...
                if (!(decodeHexDigit == -1 || decodeHexDigit2 == -1)) {
                    buffer.A((decodeHexDigit << 4) + decodeHexDigit2);
                    i = i3;
                    i += Character.charCount(codePointAt);
                }
