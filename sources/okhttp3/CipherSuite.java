...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = new C1103f5(0);
    ...
    public static final CipherSuite TLS_EMPTY_RENEGOTIATION_INFO_SCSV = init("TLS_EMPTY_RENEGOTIATION_INFO_SCSV", Constants.MAX_HOST_LENGTH);
