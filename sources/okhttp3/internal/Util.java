...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new C1103f5(1);
    private static final Options UNICODE_BOMS = Options.b(ByteString.i("efbbbf"), ByteString.i("feff"), ByteString.i("fffe"), ByteString.i("0000ffff"), ByteString.i("ffff0000"));
    ...
    public static Charset bomAwareCharset(BufferedSource bufferedSource, Charset charset) throws IOException {
        int p = bufferedSource.p(UNICODE_BOMS);
        if (p == -1) {
            return charset;
        }
        if (p == 0) {
    ...
    public static String canonicalizeHost(String str) {
        ...
        if (str.contains(":")) {
            ...
            throw new AssertionError(lf.j("Invalid IPv6 address: '", str, "'"));
        }
        try {
    ...
    public static int checkDuration(String str, long j, TimeUnit timeUnit) {
        int i = (j > 0 ? 1 : (j == 0 ? 0 : -1));
        if (i < 0) {
            throw new IllegalArgumentException(C1058d.z(str, " < 0"));
        } else if (timeUnit != null) {
            long millis = timeUnit.toMillis(j);
            if (millis > 2147483647L) {
                throw new IllegalArgumentException(C1058d.z(str, " too large."));
            } else if (millis != 0 || i <= 0) {
                return (int) millis;
            } else {
                throw new IllegalArgumentException(C1058d.z(str, " too small."));
            }
        } else {
    ...
    private static InetAddress decodeIpv6(String str, int i, int i2) {
        ...
        while (true) {
            if (i >= i2) {
                ...
                int i9 = i3 + 1;
                bArr[i3] = (byte) ((i7 >>> 8) & Constants.MAX_HOST_LENGTH);
                i3 = i9 + 1;
    ...
    private static String inet6AddressToAscii(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if (i2 == i) {
                ...
                buffer.E((long) (((bArr[i2] & UnsignedBytes.MAX_VALUE) << 8) | (bArr[i2 + 1] & UnsignedBytes.MAX_VALUE)));
                i2 += 2;
            }
        }
        return buffer.r();
    ...
    public static Headers toHeaders(List<Header> list) {
        ...
        for (Header next : list) {
            Internal.instance.addLenient(builder, next.name.E(), next.value.E());
        }
