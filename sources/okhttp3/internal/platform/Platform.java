...
public class Platform {
    ...
    public static byte[] concatLengthPrefixed(List<Protocol> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (protocol != Protocol.HTTP_1_0) {
                ...
                buffer.O(0, protocol2.length(), protocol2);
            }
        }
        return buffer.F();
    }
    ...
    public void logCloseableLeak(String str, Object obj) {
        if (obj == null) {
            str = C1058d.z(str, " To see where this was allocated, set the OkHttpClient logger level to FINE: Logger.getLogger(OkHttpClient.class.getName()).setLevel(Level.FINE);");
        }
    ...
    public X509TrustManager trustManager(SSLSocketFactory sSLSocketFactory) {
        try {
            Object readFieldOrNull = readFieldOrNull(sSLSocketFactory, Class.forName("sun.security.ssl.SSLContextImpl"), LogCategory.CONTEXT);
