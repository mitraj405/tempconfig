...
public final class Exchange {
    ...
    public final class RequestBodySink extends C1258md {
    ...
    public final class ResponseBodySource extends C1280nd {
        private long bytesReceived;
        private boolean closed;
        private boolean completed;
    ...
    public ResponseBody openResponseBody(Response response) throws IOException {
        try {
            ...
            return new RealResponseBody(header, reportedContentLength, new As(responseBodySource));
        } catch (IOException e) {
