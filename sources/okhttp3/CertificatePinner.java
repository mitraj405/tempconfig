...
public final class CertificatePinner {
    ...
    public static final class Pin {
        ...
        public Pin(String str, String str2) {
            ...
            if (str2.startsWith("sha1/")) {
                ...
                this.hash = ByteString.f(str2.substring(5));
            } else if (str2.startsWith("sha256/")) {
                this.hashAlgorithm = "sha256/";
                this.hash = ByteString.f(str2.substring(7));
            } else {
        ...
        public int hashCode() {
            return this.hash.hashCode() + lf.g(this.hashAlgorithm, lf.g(this.pattern, 527, 31), 31);
        }
    ...
    public static ByteString sha1(X509Certificate x509Certificate) {
        return ByteString.t(x509Certificate.getPublicKey().getEncoded()).l("SHA-1");
    }

    public static ByteString sha256(X509Certificate x509Certificate) {
        return ByteString.t(x509Certificate.getPublicKey().getEncoded()).l("SHA-256");
    }
