...
public class CancellationHistoryPagerAdapter extends C0318rd {
    private static final int ALL_JOURNEY_TABS = 0;
    private static final int NUMBER_OF_TABS = 3;
    private static final int PAST_JOURNEY_TAB = 2;
    private static final String TAG = C1354qp.R(CancellationHistoryPagerAdapter.class);
    ...
    public CancellationHistoryPagerAdapter(FragmentManager fragmentManager, TicketHistoryUtil.SortFor sortFor2) {
