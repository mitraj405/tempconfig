...
public class MealDetaillViewHolderLap2 extends RecyclerView.Adapter<ViewHolder> {
    private static final String TAG = C1354qp.R(MealDetaillViewHolderLap2.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void MinClick(View view) {
            ...
            this.tv_total_price2.setText(String.format(MealDetaillViewHolderLap2.this.mContext.getResources().getString(R.string.format_zerotimes), new Object[]{Float.valueOf(this.meal.getMealRate() * ((float) this.meal.getQuantity()))}));
        }
        ...
        public void onEditClick() {
            AddMealHolderListener addMealHolderListener = MealDetaillViewHolderLap2.this.listener;
    ...
    public MealDetaillViewHolderLap2(Context context, ArrayList<MealItemDetails> arrayList, AddMealHolderListener addMealHolderListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View r = C1058d.r(viewGroup, R.layout.item_addmeal, (ViewGroup) null);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if (mealItemDetails.getMealCode().equalsIgnoreCase("Veg")) {
            viewHolder.iv_meal_icon.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_veg, 0);
        } else {
            viewHolder.iv_meal_icon.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_non_veg, 0);
        }
