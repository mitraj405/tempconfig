...
public class LoyaltyProfileDetailViewHolder extends RecyclerView.Adapter<ViewHolder> {
    private static final String TAG = C1354qp.R(LoyaltyProfileDetailViewHolder.class);
    ArrayList<C0471CB> configurablesDTOS;
    Context mContext;
    ...
    public LoyaltyProfileDetailViewHolder(Context context, ArrayList<C0471CB> arrayList) {
        this.configurablesDTOS = arrayList;
        this.mContext = context;
    }

    public int getItemCount() {
        ArrayList<C0471CB> arrayList = this.configurablesDTOS;
        if (arrayList == null) {
            return 0;
        }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View r = C1058d.r(viewGroup, R.layout.item_loyalty_profile_detail, (ViewGroup) null);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        C0471CB cb = this.configurablesDTOS.get(i);
    }
}
