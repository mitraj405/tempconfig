...
public class Lap2MealDetaillViewHolder extends RecyclerView.Adapter<ViewHolder> {
    private static final String TAG = C1354qp.R(Lap2MealDetaillViewHolder.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void MinClick(View view) {
            ...
            this.tv_total_price2.setText(String.format(Lap2MealDetaillViewHolder.this.mContext.getResources().getString(R.string.format_zerotimes), new Object[]{Float.valueOf(this.meal.getMealRate() * ((float) this.meal.getQuantity()))}));
        }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View r = C1058d.r(viewGroup, R.layout.lap2_item_addmeal, (ViewGroup) null);
