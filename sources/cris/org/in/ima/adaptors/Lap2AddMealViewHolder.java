...
public class Lap2AddMealViewHolder extends RecyclerView.Adapter<ViewHolder> {
    private static final String TAG = C1354qp.R(Lap2AddMealViewHolder.class);
    Context mContext;
    ArrayList<MealItemDetails> mealDetailListlap2;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void MinClick(View view) {
            int k0 = C0535I5.k0(this.meal);
            if (k0 == 0) {
                this.tv_addmeal.setText("ADD");
                this.iv_meal_min.setVisibility(8);
                return;
            }
            C1058d.G(k0, "", this.tv_addmeal);
            this.iv_meal_min.setVisibility(0);
        }

        @OnClick({2131362894})
        public void PlusClick() {
            int m0 = C0535I5.m0(this.meal);
            if (m0 == 0) {
                this.tv_addmeal.setText("ADD");
                this.iv_meal_min.setVisibility(8);
                return;
            }
            C1058d.G(m0, "", this.tv_addmeal);
            this.iv_meal_min.setVisibility(0);
        }
    ...
    public Lap2AddMealViewHolder(Context context, ArrayList<MealItemDetails> arrayList) {
        this.mealDetailListlap2 = arrayList;
        this.mContext = context;
    }

    public int getItemCount() {
        ArrayList<MealItemDetails> arrayList = this.mealDetailListlap2;
        if (arrayList == null) {
            return 0;
        }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View r = C1058d.r(viewGroup, R.layout.lap2_item_addmeal_passengerpage, (ViewGroup) null);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        MealItemDetails mealItemDetails = this.mealDetailListlap2.get(i);
