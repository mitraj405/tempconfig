...
public class AddMealViewHolder extends RecyclerView.Adapter<ViewHolder> {
    private static final String TAG = C1354qp.R(AddMealViewHolder.class);
    Context mContext;
    List<MealItemDetails> mealDetailList;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        MealDetails meal;
        MealItemDetails mealItemDetails;
        @BindView(2131363201)
        TextView mealType;
        @BindView(2131363205)
        View mealview;
        ...
        public void MinClick(View view) {
            int j0 = C0535I5.j0(this.mealItemDetails);
            if (j0 == 0) {
        ...
        public void PlusClick() {
            int l0 = C0535I5.l0(this.mealItemDetails);
            if (l0 == 0) {
                this.tv_addmeal.setText("ADD");
                this.iv_meal_min.setVisibility(8);
                return;
    ...
    public AddMealViewHolder(Context context, List<MealItemDetails> list) {
        this.mealDetailList = list;
        this.mContext = context;
    }

    public int getItemCount() {
        List<MealItemDetails> list = this.mealDetailList;
        if (list == null) {
            return 0;
        }
        return list.size();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View r = C1058d.r(viewGroup, R.layout.item_addmeal_passengerpage, (ViewGroup) null);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.mealItemDetails = mealItemDetails;
