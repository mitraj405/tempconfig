...
public class MealDetaillViewHolder extends RecyclerView.Adapter<ViewHolder> {
    private static final String TAG = C1354qp.R(MealDetaillViewHolder.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void MinClick(View view) {
            ...
            this.tv_total_price2.setText(String.format(MealDetaillViewHolder.this.mContext.getResources().getString(R.string.format_zerotimes), new Object[]{Float.valueOf(this.meal.getMealRate() * ((float) this.meal.getQuantity()))}));
        }
        ...
        public void onEditClick() {
            AddMealHolderListener addMealHolderListener = MealDetaillViewHolder.this.listener;
    ...
    public MealDetaillViewHolder(Context context, ArrayList<MealItemDetails> arrayList, AddMealHolderListener addMealHolderListener) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        TextView textView2 = viewHolder.tv_total_price;
        StringBuilder sb = new StringBuilder("₹ ");
        sb.append(String.format(this.mContext.getResources().getString(R.string.format_zerotimes), new Object[]{Float.valueOf(mealItemDetails.getMealRate() * ((float) mealItemDetails.getQuantity()))}));
