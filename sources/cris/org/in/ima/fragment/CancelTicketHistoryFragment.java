...
public class CancelTicketHistoryFragment extends Fragment {
    ...
    /* renamed from: a  reason: collision with other field name */
    public FragmentActivity f4493a;

    /* renamed from: a  reason: collision with other field name */
    public CancelTicketItemAdapter f4494a;

    /* renamed from: a  reason: collision with other field name */
    public ArrayList<BookingResponseDTO> f4495a;

    /* renamed from: a  reason: collision with other field name */
    public C1223kn f4496a;
    @BindView(2131362060)
    TextView booking;
    @BindView(2131363807)
    ...
    static {
        C1354qp.R(CancelTicketHistoryFragment.class);
    }
    ...
    public final void g(int i) {
        ArrayList<BookingResponseDTO> arrayList = this.f4495a;
        if (arrayList == null || arrayList.size() == 0) {
            arrayList = null;
        } else if (i == 1) {
            Collections.sort(arrayList, new C1170i4());
        } else if (i == 2) {
            Collections.sort(arrayList, new C1189j4());
        }
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.f4492a = getContext();
        this.f4493a = getActivity();
        if (!C0535I5.O((ConnectivityManager) this.f4492a.getSystemService("connectivity"), this.f4492a)) {
            new Handler().postDelayed(new C1083e4(), 5000);
        } else {
            this.a = ProgressDialog.show(getActivity(), getString(R.string.fetching_tkt_list), getString(R.string.please_wait_text));
            ...
            try {
                ...
                if (arrayList == null || arrayList.size() <= 0) {
                    String f = C0657Qt.f();
                    ((Om) C0657Qt.c(this.f4496a)).K0(f + "tktEligibleForCancellation").c(C1181iv.a()).a(E0.a()).b(new B(this));
                } else {
                    this.f4494a = new CancelTicketItemAdapter(this.f4492a, new C1102f4(this), this.f4495a);
                    this.bookingItems.setLayoutManager(new LinearLayoutManager(this.f4493a));
                    this.bookingItems.setAdapter(this.f4494a);
                    this.a.dismiss();
                }
