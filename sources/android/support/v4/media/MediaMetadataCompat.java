...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            ...
            if (!arrayMap.containsKey(str) || arrayMap.getOrDefault(str, null).intValue() == 2) {
                this.mBundle.putParcelable(str, bitmap);
                return this;
            }
            throw new IllegalArgumentException(lf.j("The ", str, " key cannot be used to put a Bitmap"));
        }

        public Builder putLong(String str, long j) {
            ArrayMap<String, Integer> arrayMap = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!arrayMap.containsKey(str) || arrayMap.getOrDefault(str, null).intValue() == 0) {
                this.mBundle.putLong(str, j);
                return this;
            }
            throw new IllegalArgumentException(lf.j("The ", str, " key cannot be used to put a long"));
        }

        public Builder putRating(String str, RatingCompat ratingCompat) {
            ArrayMap<String, Integer> arrayMap = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!arrayMap.containsKey(str) || arrayMap.getOrDefault(str, null).intValue() == 3) {
                this.mBundle.putParcelable(str, (Parcelable) ratingCompat.getRating());
                return this;
            }
            throw new IllegalArgumentException(lf.j("The ", str, " key cannot be used to put a Rating"));
        }
        ...
        public Builder putString(String str, String str2) {
            ...
            throw new IllegalArgumentException(lf.j("The ", str, " key cannot be used to put a String"));
        }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            ...
            throw new IllegalArgumentException(lf.j("The ", str, " key cannot be used to put a CharSequence"));
        }
