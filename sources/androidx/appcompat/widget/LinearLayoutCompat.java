...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public void layoutHorizontal(int r25, int r26, int r27, int r28) {
        /*
            r24 = this;
            r6 = r24
            boolean r0 = defpackage.UC.a(r24)
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        int[] iArr = ps.LinearLayoutCompat;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i, 0);
        TintTypedArray tintTypedArray = new TintTypedArray(context, obtainStyledAttributes);
        f.n(this, context, iArr, attributeSet, obtainStyledAttributes, i);
        int h = tintTypedArray.h(ps.LinearLayoutCompat_android_orientation, -1);
        if (h >= 0) {
            setOrientation(h);
        }
        int h2 = tintTypedArray.h(ps.LinearLayoutCompat_android_gravity, -1);
        if (h2 >= 0) {
            setGravity(h2);
        }
        boolean a = tintTypedArray.a(ps.LinearLayoutCompat_android_baselineAligned, true);
        if (!a) {
            setBaselineAligned(a);
        }
        this.mWeightSum = obtainStyledAttributes.getFloat(ps.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = tintTypedArray.h(ps.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = tintTypedArray.a(ps.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(tintTypedArray.e(ps.LinearLayoutCompat_divider));
        this.mShowDividers = tintTypedArray.h(ps.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = tintTypedArray.d(ps.LinearLayoutCompat_dividerPadding, 0);
        tintTypedArray.n();
    }
