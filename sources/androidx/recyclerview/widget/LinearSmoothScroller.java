...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public void updateActionForInterimTarget(RecyclerView.SmoothScroller.Action action) {
        ...
        action.b((int) (((float) this.mInterimTargetDx) * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (((float) this.mInterimTargetDy) * TARGET_SEEK_EXTRA_SCROLL_RATIO), this.mLinearInterpolator, (int) (((float) calculateTimeForScrolling) * TARGET_SEEK_EXTRA_SCROLL_RATIO));
    }
