...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return C0709Uj.j(new StringBuilder(), Utils.typeToString(this.componentType), "[]");
        }
    }
    ...
    public static Type getParameterUpperBound(int i, ParameterizedType parameterizedType) {
        ...
        if (i < 0 || i >= actualTypeArguments.length) {
            StringBuilder m = lf.m("Index ", i, " not in range [0,");
    ...
    public static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        StringBuilder n = lf.n(str, " (parameter #");
        n.append(i + 1);
        n.append(")");
        return methodError(method, n.toString(), objArr);
    }
    ...
    public static RuntimeException methodError(Method method, Throwable th, String str, Object... objArr) {
        StringBuilder n = lf.n(String.format(str, objArr), "\n    for method ");
        n.append(method.getDeclaringClass().getSimpleName());
        n.append(".");
        n.append(method.getName());
        return new IllegalArgumentException(n.toString(), th);
    }
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i, String str, Object... objArr) {
        ...
        n.append(i + 1);
        n.append(")");
        return methodError(method, th, n.toString(), objArr);
    }
}
