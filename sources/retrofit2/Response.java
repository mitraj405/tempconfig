...
public final class Response<T> {
    ...
    public static <T> Response<T> error(int i, ResponseBody responseBody) {
        ...
        throw new IllegalArgumentException(lf.h("code < 400: ", i));
    }

    public static <T> Response<T> success(T t) {
        return success(t, new Response.Builder().code(LogSeverity.INFO_VALUE).message("OK").protocol(Protocol.HTTP_1_1).request(new Request.Builder().url("http://localhost/").build()).build());
    }
    ...
    public static <T> Response<T> success(int i, T t) {
        ...
        throw new IllegalArgumentException(lf.h("code < 200 or >= 300: ", i));
    }
    ...
    public static <T> Response<T> success(T t, Headers headers) {
        ...
        return success(t, new Response.Builder().code(LogSeverity.INFO_VALUE).message("OK").protocol(Protocol.HTTP_1_1).headers(headers).request(new Request.Builder().url("http://localhost/").build()).build());
    }
