...
*/
    ...
    public JsonLocation getCurrentLocation() {
        return new JsonLocation(_contentReference(), -1, this._currInputProcessed + ((long) this._inputPtr), this._currInputRow, (this._inputPtr - this._currInputRowStart) + 1);
    }
    ...
    public JsonLocation getTokenLocation() {
        if (this._currToken == JsonToken.FIELD_NAME) {
            ...
            return new JsonLocation(_contentReference(), -1, (this._nameStartOffset - 1) + j, this._nameStartRow, this._nameStartCol);
        }
