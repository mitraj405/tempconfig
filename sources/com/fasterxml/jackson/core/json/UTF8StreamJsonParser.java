...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    private final int _decodeUtf8_2(int i) throws IOException {
        ...
        byte b = bArr[i2];
        if ((b & 192) != 128) {
            _reportInvalidOther(b & UnsignedBytes.MAX_VALUE, i3);
        }
        return ((i & 31) << 6) | (b & 63);
    }
    ...
    private final int _decodeUtf8_3(int i) throws IOException {
        ...
        byte b = bArr[i3];
        if ((b & 192) != 128) {
            _reportInvalidOther(b & UnsignedBytes.MAX_VALUE, i4);
        }
        byte b2 = (i2 << 6) | (b & 63);
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        ...
        byte b3 = bArr2[i5];
        if ((b3 & 192) != 128) {
            _reportInvalidOther(b3 & UnsignedBytes.MAX_VALUE, i6);
        }
        return (b2 << 6) | (b3 & 63);
    }
    ...
    private final int _decodeUtf8_4(int i) throws IOException {
        ...
        byte b3 = bArr2[i4];
        if ((b3 & 192) != 128) {
            _reportInvalidOther(b3 & UnsignedBytes.MAX_VALUE, i5);
        }
        byte b4 = (b2 << 6) | (b3 & 63);
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        ...
        byte b5 = bArr3[i6];
        if ((b5 & 192) != 128) {
            _reportInvalidOther(b5 & UnsignedBytes.MAX_VALUE, i7);
        }
    ...
    private final void _matchToken2(String str, int i) throws IOException {
        ...
        if ((i2 < this._inputEnd || _loadMore()) && (b = this._inputBuffer[this._inputPtr] & UnsignedBytes.MAX_VALUE) >= 48 && b != 93 && b != 125) {
    ...
    private final JsonToken _parseFloat(char[] cArr, int i, int i2, boolean z, int i3) throws IOException {
        ...
        if (r12 == 101 || r12 == 69) {
            ...
            this._inputPtr = i8 + 1;
            byte b = bArr2[i8] & UnsignedBytes.MAX_VALUE;
            if (b == 45 || b == 43) {
                if (i7 >= cArr.length) {
                    cArr = this._textBuffer.finishCurrentSegment();
                    i7 = 0;
                ...
                b = bArr3[i10] & UnsignedBytes.MAX_VALUE;
                i7 = i9;
            }
            r12 = b;
            int i11 = 0;
            while (true) {
                if (r12 >= 48 && r12 <= 57) {
                    ...
                    r12 = bArr4[i13] & UnsignedBytes.MAX_VALUE;
                    i7 = i12;
                } else {
                    i5 = i11;
                    r11 = i7;
    ...
    private final JsonToken _parseNumber2(char[] cArr, int i, boolean z, int i2) throws IOException {
        ...
        while (true) {
            if (this._inputPtr < this._inputEnd || _loadMore()) {
                ...
                i3 = i6 + 1;
                this._inputPtr = i3;
                b = bArr[i6] & UnsignedBytes.MAX_VALUE;
                if (b <= 57 && b >= 48) {
                    if (i4 >= cArr2.length) {
                        i4 = 0;
    ...
    private final void _skipUtf8_2() throws IOException {
        ...
        byte b = bArr[i];
        if ((b & 192) != 128) {
            _reportInvalidOther(b & UnsignedBytes.MAX_VALUE, i2);
        }
    }
    ...
    private final void _skipUtf8_3() throws IOException {
        ...
        byte b2 = bArr2[i3];
        if ((b2 & 192) != 128) {
            _reportInvalidOther(b2 & UnsignedBytes.MAX_VALUE, i4);
        }
    }
    ...
    private final void _skipUtf8_4(int i) throws IOException {
        ...
        byte b2 = bArr2[i4];
        if ((b2 & 192) != 128) {
            _reportInvalidOther(b2 & UnsignedBytes.MAX_VALUE, i5);
        }
        if (this._inputPtr >= this._inputEnd) {
            _loadMoreGuaranteed();
        }
        ...
        byte b3 = bArr3[i6];
        if ((b3 & 192) != 128) {
            _reportInvalidOther(b3 & UnsignedBytes.MAX_VALUE, i7);
        }
    }
    ...
    private final int _skipWSOrEnd() throws IOException {
        ...
        if (b <= 32) {
            ...
            while (true) {
                ...
                int i4 = i3 + 1;
                this._inputPtr = i4;
                byte b2 = bArr2[i3] & UnsignedBytes.MAX_VALUE;
                if (b2 > 32) {
                    if (b2 != 47 && b2 != 35) {
                        return b2;
                    }
...
*/
    ...
    public final boolean _loadMore() throws IOException {
        ...
        _closeInput();
        if (read == 0) {
            throw new IOException(lf.k(new StringBuilder("InputStream.read() returned 0 characters when trying to read "), this._inputBuffer.length, " bytes"));
        }
        return false;
    }
    ...
    public final void _matchToken(String str, int i) throws IOException {
        ...
        byte b = this._inputBuffer[i2] & UnsignedBytes.MAX_VALUE;
        if (b >= 48 && b != 93 && b != 125) {
            _checkMatchEnd(str, i, b);
        }
    }
    ...
    public JsonToken _parseNegNumber() throws IOException {
        ...
        while (true) {
            ...
            i = i6 + 1;
            this._inputPtr = i;
            b = bArr2[i6] & UnsignedBytes.MAX_VALUE;
            if (b >= 48 && b <= 57) {
                i5++;
                ...
                if (iArr2[b2] == 0) {
                    ...
                    if (iArr2[b4] == 0) {
                        ...
                        if (iArr2[b6] == 0) {
                            int i9 = (b5 << 8) | b6;
                            this._inputPtr = i8 + 1;
                            byte b7 = bArr[i8] & UnsignedBytes.MAX_VALUE;
                            if (iArr2[b7] == 0) {
