...
public class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    private void _prependOrWriteCharacterEscape(char c, int i) throws IOException, JsonGenerationException {
        ...
        if (i >= 0) {
            ...
            if (i5 >= 6) {
                ...
                cArr3[i7] = 'u';
                if (c > 255) {
                    int i8 = (c >> 8) & Constants.MAX_HOST_LENGTH;
                    int i9 = i7 + 1;
                    char[] cArr4 = HEX_CHARS;
                    cArr3[i9] = cArr4[i8 >> 4];
                    i2 = i9 + 1;
            ...
            this._outputHead = this._outputTail;
            if (c > 255) {
                int i12 = (c >> 8) & Constants.MAX_HOST_LENGTH;
                char c2 = c & 255;
    ...
    public final void _writeBinary(Base64Variant base64Variant, byte[] bArr, int i, int i2) throws IOException, JsonGenerationException {
        ...
        while (i <= i3) {
            ...
            int i6 = i5 + 1;
            int i7 = i6 + 1;
            int encodeBase64Chunk = base64Variant.encodeBase64Chunk((int) (((bArr[i] << 8) | (bArr[i5] & UnsignedBytes.MAX_VALUE)) << 8) | (bArr[i6] & UnsignedBytes.MAX_VALUE), this._outputBuffer, this._outputTail);
    ...
    public final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        while (true) {
            ...
            i5 = i8 + 1;
            i -= 3;
            int encodeBase64Chunk = base64Variant.encodeBase64Chunk((int) (((bArr[i7] & UnsignedBytes.MAX_VALUE) | (bArr[i5] << 8)) << 8) | (bArr[i8] & UnsignedBytes.MAX_VALUE), this._outputBuffer, this._outputTail);
            this._outputTail = encodeBase64Chunk;
            maxLineLength--;
            if (maxLineLength <= 0) {
                char[] cArr = this._outputBuffer;
    ...
    public final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr) throws IOException, JsonGenerationException {
        ...
        while (true) {
            ...
            i4 = i8 + 1;
            i6 += 3;
            int encodeBase64Chunk = base64Variant.encodeBase64Chunk((int) (((bArr[i7] & UnsignedBytes.MAX_VALUE) | (bArr[i4] << 8)) << 8) | (bArr[i8] & UnsignedBytes.MAX_VALUE), this._outputBuffer, this._outputTail);
            this._outputTail = encodeBase64Chunk;
            maxLineLength--;
            if (maxLineLength <= 0) {
                char[] cArr = this._outputBuffer;
    ...
    private int _prependOrWriteCharacterEscape(char[] cArr, int i, int i2, char c, int i3) throws IOException, JsonGenerationException {
        ...
        if (i3 >= 0) {
            ...
            this._outputHead = this._outputTail;
            if (c > 255) {
                int i7 = (c >> 8) & Constants.MAX_HOST_LENGTH;
                char c2 = c & 255;
                char[] cArr4 = HEX_CHARS;
                cArr3[10] = cArr4[i7 >> 4];
            ...
            cArr[i9] = 'u';
            if (c > 255) {
                int i11 = (c >> 8) & Constants.MAX_HOST_LENGTH;
                int i12 = i10 + 1;
