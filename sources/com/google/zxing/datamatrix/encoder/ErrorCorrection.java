            ...
            for (int i6 = 0; i6 < charSequence.length(); i6++) {
                ...
                while (i7 > 0) {
                    if (charAt == 0 || (i3 = iArr2[i7]) == 0) {
                        ...
                        int[] iArr3 = ALOG;
                        int[] iArr4 = LOG;
                        cArr[i7] = (char) (iArr3[(iArr4[charAt] + iArr4[i3]) % Constants.MAX_HOST_LENGTH] ^ c);
                    }
                    i7--;
                }
                if (charAt == 0 || (i2 = iArr2[0]) == 0) {
                    ...
                    int[] iArr5 = ALOG;
                    int[] iArr6 = LOG;
                    cArr[0] = (char) iArr5[(iArr6[charAt] + iArr6[i2]) % Constants.MAX_HOST_LENGTH];
                }
            }
