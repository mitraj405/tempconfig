                ...
                if (patternToChar == '*') {
                    ...
                    if (nextSet2 == size || (i6 << 1) >= i4) {
                        ...
                        if (sb.length() != 0) {
                            ...
                            float f = (float) i;
                            return new Result(str, (byte[]) null, new ResultPoint[]{new ResultPoint(((float) (findAsteriskPattern[1] + findAsteriskPattern[0])) / 2.0f, f), new ResultPoint((((float) i4) / 2.0f) + ((float) nextSet), f)}, BarcodeFormat.CODE_39);
                        }
                        throw NotFoundException.getNotFoundInstance();
                    }
                    throw NotFoundException.getNotFoundInstance();
