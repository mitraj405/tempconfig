...
public class Code93Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            StringBuilder J = xx.J(convertToExtended);
            J.append("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".charAt(computeChecksumIndex));
            int appendPattern3 = appendPattern2 + appendPattern(zArr, appendPattern2, iArr[computeChecksumIndex(J.toString(), 15)]);
