...
public final class Detector {
    ...
    private Point getMatrixCenter() {
        ...
        return new Point(MathUtils.round((resultPoint7.getX() + (resultPoint5.getX() + (resultPoint8.getX() + resultPoint6.getX()))) / 4.0f), MathUtils.round((resultPoint7.getY() + (resultPoint5.getY() + (resultPoint8.getY() + resultPoint6.getY()))) / 4.0f));
    }
