...
public final class PDF417 {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:11:0x0056 A[LOOP:1: B:10:0x0054->B:11:0x0056, LOOP_END] */
    ...
    private void encodeLowLevel(java.lang.CharSequence r11, int r12, int r13, int r14, com.google.zxing.pdf417.encoder.BarcodeMatrix r15) {
        /*
            r10 = this;
            r0 = 0
            r1 = r0
        ...
        L_0x0003:
            ...
            int r3 = r1 % 3
            r15.startRow()
            r4 = 130728(0x1fea8, float:1.83189E-40)
            com.google.zxing.pdf417.encoder.BarcodeRow r5 = r15.getCurrentRow()
            r6 = 17
            encodeChar(r4, r6, r5)
            r4 = 1
        ...
        L_0x0037:
            ...
            int r8 = r8 + r5
        L_0x0046:
            int[][] r5 = CODEWORD_TABLE
            r5 = r5[r3]
            r5 = r5[r7]
            com.google.zxing.pdf417.encoder.BarcodeRow r7 = r15.getCurrentRow()
            encodeChar(r5, r6, r7)
            r5 = r0
        L_0x0054:
            if (r5 >= r12) goto L_0x006c
            int[][] r7 = CODEWORD_TABLE
            r7 = r7[r3]
            char r9 = r11.charAt(r2)
            r7 = r7[r9]
            com.google.zxing.pdf417.encoder.BarcodeRow r9 = r15.getCurrentRow()
            encodeChar(r7, r6, r9)
            int r2 = r2 + 1
            int r5 = r5 + 1
            goto L_0x0054
        L_0x006c:
            boolean r5 = r10.compact
            r7 = 260649(0x3fa29, float:3.65247E-40)
            if (r5 == 0) goto L_0x007b
            com.google.zxing.pdf417.encoder.BarcodeRow r3 = r15.getCurrentRow()
            encodeChar(r7, r4, r3)
            goto L_0x0091
        L_0x007b:
            int[][] r4 = CODEWORD_TABLE
            r3 = r4[r3]
            r3 = r3[r8]
            com.google.zxing.pdf417.encoder.BarcodeRow r4 = r15.getCurrentRow()
            encodeChar(r3, r6, r4)
            r3 = 18
            com.google.zxing.pdf417.encoder.BarcodeRow r4 = r15.getCurrentRow()
            encodeChar(r7, r3, r4)
        ...
        L_0x0095:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.pdf417.encoder.PDF417.encodeLowLevel(java.lang.CharSequence, int, int, int, com.google.zxing.pdf417.encoder.BarcodeMatrix):void");
    }
    ...
    public void generateBarcodeLogic(String str, int i) throws WriterException {
        ...
        if (errorCorrectionCodewordCount + length + 1 <= 929) {
            ...
            encodeLowLevel(C1058d.z(sb2, generateErrorCorrection), i2, i3, i, this.barcodeMatrix);
            return;
        }
