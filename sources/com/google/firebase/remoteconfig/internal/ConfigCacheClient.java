...
public class ConfigCacheClient {
    private static final Executor DIRECT_EXECUTOR = new Pk(4);
    ...
    public synchronized Task<ConfigContainer> get() {
        ...
        if (task == null || (task.isComplete() && !this.cachedContainerTask.isSuccessful())) {
            ...
            this.cachedContainerTask = Tasks.call(executor2, new A6(configStorageClient));
        }
    ...
    public Task<ConfigContainer> put(ConfigContainer configContainer, boolean z) {
        return Tasks.call(this.executor, new C0424zc(1, this, configContainer)).onSuccessTask(this.executor, new B6(this, z, configContainer));
    }
}
