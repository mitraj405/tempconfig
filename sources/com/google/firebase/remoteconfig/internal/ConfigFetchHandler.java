...
public class ConfigFetchHandler {
    ...
    private Task<FetchResponse> fetchFromBackendAndCacheResponse(String str, String str2, Date date, Map<String, String> map) {
        try {
            ...
            return this.fetchedConfigsCache.put(fetchFromBackend.getFetchedConfigs()).onSuccessTask(this.executor, new L(fetchFromBackend, 8));
    ...
    public Task<FetchResponse> lambda$fetch$0(Task<ConfigContainer> task, long j, Map<String, String> map) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            task2 = Tasks.whenAllComplete((Task<?>[]) new Task[]{id, token}).continueWithTask(this.executor, new D6(this, id, token, date, map));
        }
        return task2.continueWithTask(this.executor, new n7(this, date));
    }
    ...
    public Task<FetchResponse> fetchNowWithTypeAndAttemptNumber(FetchType fetchType, int i) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new C0420zB(this, hashMap));
    }
    ...
    public Task<FetchResponse> fetch(long j) {
        ...
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new C6(this, j, hashMap));
    }
}
