...
public class FirebaseApp {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            ...
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    while (true) {
                        if (!atomicReference.compareAndSet((Object) null, globalBackgroundStateListener)) {
    ...
    public static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            ...
            if (INSTANCE.get() == null) {
                ...
                while (true) {
                    if (!atomicReference.compareAndSet((Object) null, userUnlockReceiver)) {
                        if (atomicReference.get() != null) {
                            z = false;
                            break;
                        }
    ...
    public FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        if (FB.a(context) && FirebaseInitProvider.isCurrentlyInitializing()) {
        ...
        FirebaseTrace.popTrace();
        this.dataCollectionConfigStorage = new Lazy<>(new C0317rc(this, context));
        this.defaultHeartBeatController = build.getProvider(DefaultHeartBeatController.class);
        addBackgroundStateChangeListener(new C0328sc(this));
        FirebaseTrace.popTrace();
    }
    ...
    public void initializeAllApis() {
        if (!FB.a(this.applicationContext)) {
            getName();
