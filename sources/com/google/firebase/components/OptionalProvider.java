...
class OptionalProvider<T> implements Provider<T>, Deferred<T> {
    private static final Provider<Object> EMPTY_PROVIDER = new d(0);
    private static final Deferred.DeferredHandler<Object> NOOP_HANDLER = new c();
    ...
    public void whenAvailable(Deferred.DeferredHandler<T> deferredHandler) {
        ...
        synchronized (this) {
            ...
            if (provider != provider4) {
                ...
                this.handler = new e(this.handler, deferredHandler);
                provider2 = null;
            }
        }
        if (provider2 != null) {
