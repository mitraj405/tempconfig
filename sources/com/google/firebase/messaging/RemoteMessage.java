...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(String str) {
            ...
            throw new IllegalArgumentException(C0709Uj.i("Invalid to: ", str));
        }
    ...
    public int getPriority() {
        ...
        if (string == null) {
            if (C0515Ga.AVLBLTY_ONLY.equals(this.bundle.getString(Constants.MessagePayloadKeys.PRIORITY_REDUCED_V19))) {
                return 2;
            }
            string = this.bundle.getString(Constants.MessagePayloadKeys.PRIORITY_V19);
        }
