...
public final class JsonDataEncoderBuilder implements EncoderConfig<JsonDataEncoderBuilder> {
    private static final ValueEncoder<Boolean> BOOLEAN_ENCODER = new Rg();
    private static final ObjectEncoder<Object> DEFAULT_FALLBACK_ENCODER = new Pg(0);
    private static final ValueEncoder<String> STRING_ENCODER = new Qg();
