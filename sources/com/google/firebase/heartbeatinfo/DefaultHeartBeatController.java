...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    public /* synthetic */ String lambda$getHeartBeatsHeader$1() throws Exception {
        ...
        synchronized (this) {
            ...
            jSONObject2.put("version", C0515Ga.FARE_ONLY);
    ...
    public Task<String> getHeartBeatsHeader() {
        ...
        return Tasks.call(this.backgroundExecutor, new C0302q8(this));
    }
    ...
    public Task<Void> registerHeartBeat() {
        ...
        return Tasks.call(this.backgroundExecutor, new GB(this, 1));
    }
