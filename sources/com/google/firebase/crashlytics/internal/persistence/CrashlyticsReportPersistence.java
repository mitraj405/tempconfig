...
public class CrashlyticsReportPersistence {
    ...
    private static final FilenameFilter EVENT_FILE_FILTER = new B7();
    private static final String EVENT_FILE_NAME_PREFIX = "event";
    private static final int EVENT_NAME_LENGTH = 15;
    private static final Comparator<? super File> LATEST_SESSION_ID_FIRST_COMPARATOR = new C0105Wc(1);
    ...
    private static String generateEventFilename(int i, boolean z) {
        ...
        return lf.j(EVENT_FILE_NAME_PREFIX, format, str);
    }
    ...
    private int trimEvents(String str, int i) {
        List<File> sessionFiles = this.fileStore.getSessionFiles(str, new A7());
        Collections.sort(sessionFiles, new Fz(1));
