...
public class HttpGetRequest {
    ...
    private String createUrlWithParams(String str, Map<String, String> map) throws UnsupportedEncodingException {
        ...
        if (!str.contains("?")) {
            return xx.D(str, "?", createParamsString);
        }
        if (!str.endsWith("&")) {
            createParamsString = "&".concat(createParamsString);
        }
        return C1058d.z(str, createParamsString);
    }
    ...
    public com.google.firebase.crashlytics.internal.network.HttpResponse execute() throws java.io.IOException {
        /*
            ...
            r0.setReadTimeout(r2)     // Catch:{ all -> 0x007f }
            r0.setConnectTimeout(r2)     // Catch:{ all -> 0x007f }
            java.lang.String r2 = "GET"
            r0.setRequestMethod(r2)     // Catch:{ all -> 0x007f }
            java.util.Map<java.lang.String, java.lang.String> r2 = r5.headers     // Catch:{ all -> 0x007f }
        ...
        L_0x0040:
            ...
            java.lang.Object r4 = r3.getKey()     // Catch:{ all -> 0x007f }
            ...
            r0.addRequestProperty(r4, r3)     // Catch:{ all -> 0x007f }
            goto L_0x0040
        L_0x005c:
            r0.connect()     // Catch:{ all -> 0x007f }
            int r2 = r0.getResponseCode()     // Catch:{ all -> 0x007f }
            java.io.InputStream r3 = r0.getInputStream()     // Catch:{ all -> 0x007f }
