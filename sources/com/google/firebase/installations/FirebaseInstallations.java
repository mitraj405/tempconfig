...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public FirebaseInstallations(FirebaseApp firebaseApp2, Provider<HeartBeatController> provider, ExecutorService executorService, Executor executor) {
        this(executorService, executor, firebaseApp2, new FirebaseInstallationServiceClient(firebaseApp2.getApplicationContext(), provider), new PersistedInstallation(firebaseApp2), Utils.getInstance(), new Lazy(new i6(firebaseApp2, 1)), new RandomFidGenerator());
    }
    ...
    public final void lambda$getToken$2(boolean z) {
        ...
        this.networkExecutor.execute(new C0341tc(this, z));
    }
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new GB(this, 2));
    }
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new gA(this, 8));
    ...
    public Task<InstallationTokenResult> getToken(boolean z) {
        ...
        this.backgroundExecutor.execute(new C0440SC(1, this, z));
