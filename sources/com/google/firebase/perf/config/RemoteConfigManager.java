...
public class RemoteConfigManager {
    ...
    private RemoteConfigManager() {
        this(DeviceCacheManager.getInstance(), new ThreadPoolExecutor(0, 1, 0, TimeUnit.SECONDS, new LinkedBlockingQueue()), (FirebaseRemoteConfig) null, ((long) new Random().nextInt(RANDOM_APP_START_CONFIG_FETCH_DELAY_MS)) + MIN_APP_START_CONFIG_FETCH_DELAY_MS, getInitialStartupMillis());
    }
    ...
    private void triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch() {
        ...
        this.firebaseRemoteConfig.fetchAndActivate().addOnSuccessListener(this.executor, new L(this, 6)).addOnFailureListener(this.executor, (OnFailureListener) new lC(this, 8));
    }
