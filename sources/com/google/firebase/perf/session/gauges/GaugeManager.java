...
public class GaugeManager {
    ...
    private GaugeManager() {
        this(new Lazy(new C0080Ab(1)), TransportManager.getInstance(), ConfigResolver.getInstance(), (GaugeMetadataManager) null, new Lazy(new Bb(2)), new Lazy(new C0406yb(1)));
    }
    ...
    public void startCollectingGauges(PerfSession perfSession, ApplicationProcessState applicationProcessState2) {
        ...
        try {
            ...
            this.gaugeManagerDataCollectionJob = this.gaugeManagerExecutor.get().scheduleAtFixedRate(new iw(this, 1, sessionId2, applicationProcessState2), j, j, TimeUnit.MILLISECONDS);
    ...
    public void stopCollectingGauges() {
        ...
        if (str != null) {
            ...
            this.gaugeManagerExecutor.get().schedule(new C0225ia(this, 2, str, applicationProcessState2), 20, TimeUnit.MILLISECONDS);
            this.sessionId = null;
