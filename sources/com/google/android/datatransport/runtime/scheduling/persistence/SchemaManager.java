...
final class SchemaManager extends SQLiteOpenHelper {
    ...
    static {
        ...
        MIGRATE_TO_V4 = vVar;
        s sVar2 = new s(1);
        MIGRATION_TO_V5 = sVar2;
        t tVar2 = new t(1);
        MIGRATE_TO_V6 = tVar2;
        u uVar2 = new u(1);
        MIGRATE_TO_V7 = uVar2;
        INCREMENTAL_MIGRATIONS = Arrays.asList(new Migration[]{sVar, tVar, uVar, vVar, sVar2, tVar2, uVar2});
    }
    ...
    private void upgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        ...
        StringBuilder C = C1058d.C("Migration from ", i, " to ", i2, " was requested, but cannot be performed. Only ");
        C.append(list.size());
