...
public final class Preconditions {
    ...
    public static void checkHandlerThread(Handler handler) {
        ...
        if (myLooper != handler.getLooper()) {
            throw new IllegalStateException(C1058d.A("Must be called on ", handler.getLooper().getThread().getName(), " thread, but got ", myLooper != null ? myLooper.getThread().getName() : "null current looper", "."));
        }
    }
