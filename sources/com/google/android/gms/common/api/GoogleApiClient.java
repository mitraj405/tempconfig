            ...
            for (Api next : this.zaj.keySet()) {
                ...
                if (buildClient.providesSignIn()) {
                    if (api == null) {
                        ...
                        String zad4 = api.zad();
                        throw new IllegalStateException(C1058d.B(new StringBuilder(String.valueOf(zad3).length() + 21 + String.valueOf(zad4).length()), zad3, " cannot be used with ", zad4));
                    }
                }
            }
            if (api != null) {
                if (!z3) {
                    ...
                    String zad5 = api.zad();
                    throw new IllegalStateException(C1058d.B(new StringBuilder(String.valueOf(zad5).length() + 82), "With using ", zad5, ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            }
