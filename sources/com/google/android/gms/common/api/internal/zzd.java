...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            zzd zzd3 = (zzd) fragmentActivity.getSupportFragmentManager().C("SupportLifecycleFragmentImpl");
            if (zzd3 == null || zzd3.isRemoving()) {
                zzd3 = new zzd();
                FragmentManager supportFragmentManager = fragmentActivity.getSupportFragmentManager();
                supportFragmentManager.getClass();
                a aVar = new a(supportFragmentManager);
                aVar.g(0, zzd3, "SupportLifecycleFragmentImpl", 1);
                aVar.d();
            }
    ...
    public final void addCallback(String str, LifecycleCallback lifecycleCallback) {
        ...
        throw new IllegalArgumentException(lf.j("LifecycleCallback with tag ", str, " already added to this fragment."));
    }
