...
final class zzw {
    ...
    public final zzfn.zzd zza(int i) {
        ...
        if (this.zzf == null) {
            ...
            for (Integer intValue : this.zzf.keySet()) {
                ...
                if (l != null) {
                    arrayList.add((zzfn.zze) ((zzjk) zzfn.zze.zzc().zza(intValue2).zza(l.longValue()).zzai()));
                }
            }
        }
        if (arrayList != null) {
        ...
        if (this.zzg == null) {
            ...
            for (Integer next : this.zzg.keySet()) {
                zzfn.zzn.zza zza2 = zzfn.zzn.zzc().zza(next.intValue());
    ...
    public final void zza(zzz zzz) {
        int zza2 = zzz.zza();
        Boolean bool = zzz.zzc;
        if (bool != null) {
            this.zze.set(zza2, bool.booleanValue());
        }
        Boolean bool2 = zzz.zzd;
        if (bool2 != null) {
