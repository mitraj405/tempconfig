...
public final class zzms {
    ...
    public final Bundle zza() {
        String str;
        String str2;
        if (!(C0515Ga.AVLBLTY_ONLY.equals(this.zzb.get("GoogleConsent")) && C0515Ga.AVLBLTY_ONLY.equals(this.zzb.get("gdprApplies")) && C0515Ga.AVLBLTY_ONLY.equals(this.zzb.get("EnableAdvertiserConsentMode")))) {
            return Bundle.EMPTY;
        }
        int zze = zze();
        if (zze < 0) {
    ...
    public final String zzb() {
        StringBuilder sb = new StringBuilder(C0515Ga.AVLBLTY_ONLY);
        int zzd = zzd();
        if (zzd < 0 || zzd > 4095) {
            sb.append("00");
        } else {
        ...
        int i = (C0515Ga.AVLBLTY_ONLY.equals(this.zzb.get("gdprApplies")) ? 2 : 0) | 4;
        if (C0515Ga.AVLBLTY_ONLY.equals(this.zzb.get("EnableAdvertiserConsentMode"))) {
            i |= 8;
        }
