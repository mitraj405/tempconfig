...
public final class zzau {
    ...
    public static void zza(zzfw zzfw, SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String[] strArr) throws SQLiteException {
        if (zzfw != null) {
    ...
    public static void zza(zzfw zzfw, SQLiteDatabase sQLiteDatabase) {
        if (zzfw != null) {
