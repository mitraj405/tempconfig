...
public final class zzag extends zzij {
    ...
    public final boolean zzj(String str) {
        return C0515Ga.AVLBLTY_ONLY.equals(this.zzc.zza(str, "gaia_collection_enabled"));
    }

    public final boolean zzk(String str) {
        return C0515Ga.AVLBLTY_ONLY.equals(this.zzc.zza(str, "measurement.event_sampling_enabled"));
    }
    ...
    public final boolean zzf(String str, zzfj<Boolean> zzfj) {
        ...
        return zzfj.zza(Boolean.valueOf(C0515Ga.AVLBLTY_ONLY.equals(zza2))).booleanValue();
    }
