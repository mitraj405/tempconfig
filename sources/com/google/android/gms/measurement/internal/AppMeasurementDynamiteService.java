    ...
    public class zza implements zziu {
        ...
        public final void onEvent(String str, String str2, Bundle bundle, long j) {
            try {
                ...
                zzhj zzhj = AppMeasurementDynamiteService.this.zza;
                if (zzhj != null) {
                    zzhj.zzj().zzu().zza("Event listener threw exception", e);
                }
            }
        }
    }
    ...
    public class zzb implements zzir {
        ...
        public final void interceptEvent(String str, String str2, Bundle bundle, long j) {
            try {
                ...
                zzhj zzhj = AppMeasurementDynamiteService.this.zza;
                if (zzhj != null) {
                    zzhj.zzj().zzu().zza("Event interceptor threw exception", e);
                }
            }
        }
    }
