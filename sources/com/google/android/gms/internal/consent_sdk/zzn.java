...
final class zzn {
    ...
    public /* synthetic */ zzn(zzl zzl, Activity activity, ConsentDebugSettings consentDebugSettings, ConsentRequestParameters consentRequestParameters, zzm zzm) {
        this.zza = zzl;
        this.zzb = activity;
    ...
    public static /* bridge */ /* synthetic */ zzci zza(zzn zzn) {
        ArrayList arrayList;
        List list;
