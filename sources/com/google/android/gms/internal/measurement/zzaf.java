...
public final class zzaf implements zzak, zzaq, Iterable<zzaq> {
    ...
    public final boolean zzc(int i) {
        ...
        throw new IndexOutOfBoundsException(lf.h("Out of bounds index: ", i));
    }
        ...
        if (i <= intValue && i >= 0) {
            ...
            while (true) {
                ...
                if (i <= this.zza.lastKey().intValue()) {
                    zzaq zzaq = this.zza.get(Integer.valueOf(i));
                    if (zzaq != null) {
    ...
    public final zzaq zza(int i) {
        ...
        } else if (!zzc(i) || (zzaq = this.zza.get(Integer.valueOf(i))) == null) {
            return zzaq.zzc;
        } else {
            return zzaq;
        }
    ...
    public final void zza(int i, zzaq zzaq) {
        if (i < 0) {
            throw new IllegalArgumentException(lf.h("Invalid value index: ", i));
        } else if (i >= zzb()) {
            zzb(i, zzaq);
        } else {
