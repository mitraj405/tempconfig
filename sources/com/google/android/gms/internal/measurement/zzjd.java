...
final class zzjd<T extends zzjf<T>> {
    ...
    public static int zza(zzmn zzmn, int i, Object obj) {
        int zzi = zzit.zzi(i);
        if (zzmn == zzmn.GROUP) {
            zzjm.zza((zzkt) obj);
            zzi <<= 1;
    ...
    public static int zza(zzjf<?> zzjf, Object obj) {
        ...
        if (!zzjf.zzd()) {
            ...
            return zzit.zzj(i) + zzit.zzi(zza2) + i;
        }
    }
    ...
    public static void zza(zzit zzit, zzmn zzmn, int i, Object obj) throws IOException {
        if (zzmn == zzmn.GROUP) {
            zzkt zzkt = (zzkt) obj;
            zzjm.zza(zzkt);
            zzit.zzc(i, 3);
