...
final class zzhw {
    ...
    public static int zzd(byte[] bArr, int i, zzhv zzhv) {
        int i2 = i + 1;
        long j = (long) bArr[i];
        if (j >= 0) {
            zzhv.zzb = j;
    ...
    public static int zza(byte[] bArr, int i, zzhv zzhv) throws zzjs {
    ...
    public static int zzb(byte[] bArr, int i, zzhv zzhv) throws zzjs {
        int zzc = zzc(bArr, i, zzhv);
        int i2 = zzhv.zza;
        if (i2 < 0) {
            throw zzjs.zzf();
    ...
    public static int zzc(byte[] bArr, int i, zzhv zzhv) {
        int i2 = i + 1;
        byte b = bArr[i];
        if (b < 0) {
            return zza((int) b, bArr, i2, zzhv);
        }
        zzhv.zza = b;
        return i2;
    }
    ...
    public static int zza(zzll zzll, byte[] bArr, int i, int i2, int i3, zzhv zzhv) throws IOException {
        Object zza = zzll.zza();
    ...
    public static int zza(zzll zzll, byte[] bArr, int i, int i2, zzhv zzhv) throws IOException {
        Object zza = zzll.zza();
    ...
    public static int zza(zzll<?> zzll, int i, byte[] bArr, int i2, int i3, zzjt<?> zzjt, zzhv zzhv) throws IOException {
    ...
    public static int zza(byte[] bArr, int i, zzjt<?> zzjt, zzhv zzhv) throws IOException {
        zzjn zzjn = (zzjn) zzjt;
        int zzc = zzc(bArr, i, zzhv);
        int i2 = zzhv.zza + zzc;
        while (zzc < i2) {
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzme zzme, zzhv zzhv) throws zzjs {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
    ...
    public static int zza(int i, byte[] bArr, int i2, zzhv zzhv) {
        int i3 = i & 127;
        int i4 = i2 + 1;
        byte b = bArr[i2];
        if (b >= 0) {
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzjt<?> zzjt, zzhv zzhv) {
        zzjn zzjn = (zzjn) zzjt;
        int zzc = zzc(bArr, i2, zzhv);
        zzjn.zzd(zzhv.zza);
        while (zzc < i3) {
    ...
    public static int zza(Object obj, zzll zzll, byte[] bArr, int i, int i2, int i3, zzhv zzhv) throws IOException {
    ...
    public static int zza(java.lang.Object r6, com.google.android.gms.internal.measurement.zzll r7, byte[] r8, int r9, int r10, com.google.android.gms.internal.measurement.zzhv r11) throws java.io.IOException {
        /*
            int r0 = r9 + 1
            byte r9 = r8[r9]
    ...
    public static int zza(int i, byte[] bArr, int i2, int i3, zzhv zzhv) throws zzjs {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
