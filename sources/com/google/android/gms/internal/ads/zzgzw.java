...
interface zzgzw {
    ...
    @Deprecated
    void zzC(List list, zzhae zzhae, zzgxi zzgxi) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzhae zzhae, zzgxi zzgxi) throws IOException;
    ...
    void zzt(Object obj, zzhae zzhae, zzgxi zzgxi) throws IOException;

    void zzu(Object obj, zzhae zzhae, zzgxi zzgxi) throws IOException;
