...
final class zzaer extends zzaet {
    ...
    private static Double zzg(zzek zzek) {
        return Double.valueOf(Double.longBitsToDouble(zzek.zzt()));
    }
    ...
    private static java.lang.Object zzh(com.google.android.gms.internal.ads.zzek r4, int r5) {
        ...
        L_0x007a:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaer.zzh(com.google.android.gms.internal.ads.zzek, int):java.lang.Object");
    }

    private static String zzi(zzek zzek) {
        int zzq = zzek.zzq();
        int zzd2 = zzek.zzd();
        zzek.zzL(zzq);
        return new String(zzek.zzM(), zzd2, zzq);
    }

    private static HashMap zzj(zzek zzek) {
        int zzp = zzek.zzp();
        HashMap hashMap = new HashMap(zzp);
        for (int i = 0; i < zzp; i++) {
            String zzi = zzi(zzek);
            Object zzh = zzh(zzek, zzek.zzm());
            if (zzh != null) {
                hashMap.put(zzi, zzh);
            }
        }
    ...
    public final boolean zza(zzek zzek) {
        return true;
    }

    public final boolean zzb(zzek zzek, long j) {
        if (zzek.zzm() == 2 && "onMetaData".equals(zzi(zzek)) && zzek.zzb() != 0 && zzek.zzm() == 8) {
            HashMap zzj = zzj(zzek);
