...
public final class zzalr {
    ...
    static {
        ...
        hashMap.put("white", Integer.valueOf(Color.rgb(Constants.MAX_HOST_LENGTH, Constants.MAX_HOST_LENGTH, Constants.MAX_HOST_LENGTH)));
        hashMap.put("lime", Integer.valueOf(Color.rgb(0, Constants.MAX_HOST_LENGTH, 0)));
        hashMap.put("cyan", Integer.valueOf(Color.rgb(0, Constants.MAX_HOST_LENGTH, Constants.MAX_HOST_LENGTH)));
        hashMap.put("red", Integer.valueOf(Color.rgb(Constants.MAX_HOST_LENGTH, 0, 0)));
        hashMap.put("yellow", Integer.valueOf(Color.rgb(Constants.MAX_HOST_LENGTH, Constants.MAX_HOST_LENGTH, 0)));
        hashMap.put("magenta", Integer.valueOf(Color.rgb(Constants.MAX_HOST_LENGTH, 0, Constants.MAX_HOST_LENGTH)));
        hashMap.put("blue", Integer.valueOf(Color.rgb(0, 0, Constants.MAX_HOST_LENGTH)));
        hashMap.put("black", Integer.valueOf(Color.rgb(0, 0, 0)));
        zzc = Collections.unmodifiableMap(hashMap);
        HashMap hashMap2 = new HashMap();
        hashMap2.put("bg_white", Integer.valueOf(Color.rgb(Constants.MAX_HOST_LENGTH, Constants.MAX_HOST_LENGTH, Constants.MAX_HOST_LENGTH)));
        hashMap2.put("bg_lime", Integer.valueOf(Color.rgb(0, Constants.MAX_HOST_LENGTH, 0)));
        hashMap2.put("bg_cyan", Integer.valueOf(Color.rgb(0, Constants.MAX_HOST_LENGTH, Constants.MAX_HOST_LENGTH)));
        hashMap2.put("bg_red", Integer.valueOf(Color.rgb(Constants.MAX_HOST_LENGTH, 0, 0)));
        hashMap2.put("bg_yellow", Integer.valueOf(Color.rgb(Constants.MAX_HOST_LENGTH, Constants.MAX_HOST_LENGTH, 0)));
        hashMap2.put("bg_magenta", Integer.valueOf(Color.rgb(Constants.MAX_HOST_LENGTH, 0, Constants.MAX_HOST_LENGTH)));
        hashMap2.put("bg_blue", Integer.valueOf(Color.rgb(0, 0, Constants.MAX_HOST_LENGTH)));
    ...
    public static android.text.SpannedString zza(java.lang.String r17, java.lang.String r18, java.util.List r19) {
        ...
        L_0x001d:
            ...
            com.google.android.gms.internal.ads.zzalo r1 = (com.google.android.gms.internal.ads.zzalo) r1
            zzg(r0, r1, r5, r3, r2)
            goto L_0x001d
        L_0x002d:
            com.google.android.gms.internal.ads.zzalo r1 = com.google.android.gms.internal.ads.zzalo.zzb()
        ...
        L_0x0099:
            ...
            int r16 = com.google.android.gms.internal.ads.zzet.zza
        ...
        L_0x0161:
            ...
            int r6 = r3.length()
            com.google.android.gms.internal.ads.zzalo r6 = com.google.android.gms.internal.ads.zzalo.zza(r7, r6)
            r4.push(r6)
            goto L_0x020b
        L_0x0170:
            r6 = 59
    ...
    public static zzalk zzc(zzek zzek, List list) {
        ...
        if (zzy != null) {
            ...
            if (matcher.matches()) {
                return zze((String) null, matcher, zzek, list);
            }
            String zzy2 = zzek.zzy(charset);
            if (zzy2 != null) {
                Matcher matcher2 = pattern.matcher(zzy2);
                if (matcher2.matches()) {
                    return zze(zzy.trim(), matcher2, zzek, list);
                }
            }
        }
        return null;
    ...
    private static int zzd(List list, String str, zzalo zzalo) {
        List zzf = zzf(list, str, zzalo);
        for (int i = 0; i < zzf.size(); i++) {
            zzalj zzalj = ((zzalp) zzf.get(i)).zzb;
            if (zzalj.zze() != -1) {
                return zzalj.zze();
            }
        }
    ...
    private static zzalk zze(String str, Matcher matcher, zzek zzek, List list) {
        zzalq zzalq = new zzalq();
        try {
            String group = matcher.group(1);
            group.getClass();
            zzalq.zza = zzalt.zzb(group);
            String group2 = matcher.group(2);
            group2.getClass();
            zzalq.zzb = zzalt.zzb(group2);
            String group3 = matcher.group(3);
            group3.getClass();
            zzh(group3, zzalq);
            StringBuilder sb = new StringBuilder();
            String zzy = zzek.zzy(zzfuj.zzc);
            while (!TextUtils.isEmpty(zzy)) {
                if (sb.length() > 0) {
                    sb.append("\n");
                }
                sb.append(zzy.trim());
                zzy = zzek.zzy(zzfuj.zzc);
            }
            zzalq.zzc = zza(str, sb.toString(), list);
            return new zzalk(zzalq.zza().zzp(), zzalq.zza, zzalq.zzb);
    ...
    private static List zzf(List list, String str, zzalo zzalo) {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < list.size(); i++) {
            zzalj zzalj = (zzalj) list.get(i);
            int zzf = zzalj.zzf(str, zzalo.zza, zzalo.zzd, zzalo.zzc);
            if (zzf > 0) {
                arrayList.add(new zzalp(zzf, zzalj));
            }
        }
    ...
    private static void zzg(java.lang.String r18, com.google.android.gms.internal.ads.zzalo r19, java.util.List r20, android.text.SpannableStringBuilder r21, java.util.List r22) {
        ...
        L_0x00e1:
            ...
            r14 = r20
            r13.addAll(r14)
            java.util.Comparator r14 = com.google.android.gms.internal.ads.zzaln.zza
        ...
        L_0x00ff:
            ...
            com.google.android.gms.internal.ads.zzaln r10 = (com.google.android.gms.internal.ads.zzaln) r10
            com.google.android.gms.internal.ads.zzalo r10 = r10.zzb
            java.lang.String r10 = r10.zza
            java.lang.String r8 = "rt"
            boolean r8 = r8.equals(r10)
            if (r8 == 0) goto L_0x0157
            java.lang.Object r8 = r13.get(r15)
            com.google.android.gms.internal.ads.zzaln r8 = (com.google.android.gms.internal.ads.zzaln) r8
            com.google.android.gms.internal.ads.zzalo r10 = r8.zzb
        ...
        L_0x012e:
            r10 = 1
        L_0x012f:
            com.google.android.gms.internal.ads.zzalo r11 = r8.zzb
            int r11 = r11.zzb
            int r11 = r11 - r16
            int r8 = r8.zzc
            int r8 = r8 - r16
        ...
        L_0x0172:
            ...
            com.google.android.gms.internal.ads.zzalj r1 = r1.zzb
        ...
        L_0x0187:
            ...
            int r8 = r1.zzg()
            r3.<init>(r8)
            com.google.android.gms.internal.ads.zzdg.zza(r2, r3, r4, r5, r7)
        L_0x019a:
            boolean r3 = r1.zzz()
    ...
    private static void zzh(String str, zzalq zzalq) {
        zzalq zzalq2 = zzalq;
        ...
        while (matcher.find()) {
            ...
            try {
                ...
                if ("line".equals(group)) {
                    ...
                    if (group2.endsWith("%")) {
                        zzalq2.zze = zzalt.zza(group2);
                        zzalq2.zzf = 0;
                    } else {
                        zzalq2.zze = (float) Integer.parseInt(group2);
                        zzalq2.zzf = 1;
                    }
                    ...
                    zzalq2.zzh = zzalt.zza(group2);
                } else if ("size".equals(group)) {
                    zzalq2.zzj = zzalt.zza(group2);
