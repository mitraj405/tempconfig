...
final class zzhbe {
    private static final zzhbb zza = new zzhbc();
    ...
    public static int zzd(java.lang.String r8, byte[] r9, int r10, int r11) {
        ...
        L_0x00bd:
            r1 = r4
        L_0x00be:
            com.google.android.gms.internal.ads.zzhbd r8 = new com.google.android.gms.internal.ads.zzhbd
            int r1 = r1 + -1
            r8.<init>(r1, r0)
            throw r8
        L_0x00c6:
    ...
    public static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzgyn {
        zzhbb zzhbb = zza;
        if (byteBuffer.hasArray()) {
            return zzhbb.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        } else if (byteBuffer.isDirect()) {
            return zzhbb.zzc(byteBuffer, i, i2);
        } else {
            return zzhbb.zzc(byteBuffer, i, i2);
        }
    }

    public static String zzh(byte[] bArr, int i, int i2) throws zzgyn {
