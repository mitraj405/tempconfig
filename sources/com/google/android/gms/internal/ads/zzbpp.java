...
public final class zzbpp implements MediationBannerListener, MediationInterstitialListener, MediationNativeListener {
    ...
    public final void zzd(MediationNativeAdapter mediationNativeAdapter, zzbfy zzbfy) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzm.zze("Adapter called onAdLoaded with template id ".concat(String.valueOf(zzbfy.zzb())));
        this.zzc = zzbfy;
        try {
            this.zza.zzo();
        } catch (RemoteException e) {
    ...
    public final void zze(MediationNativeAdapter mediationNativeAdapter, zzbfy zzbfy, String str) {
        try {
            this.zza.zzr(zzbfy.zza(), str);
        } catch (RemoteException e) {
            zzm.zzl("#007 Could not call remote method.", e);
        }
    }
