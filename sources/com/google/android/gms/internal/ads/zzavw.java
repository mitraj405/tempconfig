...
public final class zzavw implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    public zzavw(Context context, zzavi zzavi) {
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            zzavv zzavv = new zzavv(this);
            this.zzf = zzavv;
            this.zzb.registerReceiver(zzavv, intentFilter);
        }
    ...
    private final void zzi(android.view.View r4) {
        ...
        L_0x0036:
            ...
            com.google.android.gms.internal.ads.zzave r0 = r3.zzj     // Catch:{ Exception -> 0x003f }
            r4.unregisterActivityLifecycleCallbacks(r0)     // Catch:{ Exception -> 0x003f }
        L_0x003f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzavw.zzi(android.view.View):void");
    }
