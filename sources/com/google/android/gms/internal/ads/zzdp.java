...
public final class zzdp implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdp(Handler handler, zzdo zzdo) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i) throws zzdq {
        ...
        zzdr.zza(z, "eglGetDisplay failed");
        int[] iArr3 = new int[2];
        ...
        zzdr.zza(z2, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", new Object[]{Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr4[0]), eGLConfigArr[0]}));
        ...
        zzdr.zza(z3, "eglCreateContext failed");
        ...
        if (i == 1) {
            ...
            zzdr.zza(z4, "eglCreatePbufferSurface failed");
        }
        zzdr.zza(EGL14.eglMakeCurrent(eGLDisplay2, eGLSurface, eGLSurface, eglCreateContext), "eglMakeCurrent failed");
        this.zzf = eGLSurface;
