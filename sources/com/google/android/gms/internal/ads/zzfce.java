...
public final class zzfce implements zzhfc {
    ...
    public zzfce(zzhfu zzhfu, zzhfu zzhfu2, zzhfu zzhfu3) {
        this.zza = zzhfu;
        this.zzb = zzhfu2;
        this.zzc = zzhfu3;
    }
    ...
    public final zzfcc zzb() {
        ...
        if (((Integer) zzba.zzc().zza(zzbbw.zzfW)).intValue() > 0) {
            if (!((Boolean) zzba.zzc().zza(zzbbw.zzfF)).booleanValue() || z) {
                zzfhh zza2 = zzfhi.zza(zzfgy.AppOpen, context, zzfgq, new zzfbg(new zzfbd()));
