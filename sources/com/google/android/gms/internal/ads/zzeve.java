...
public final class zzeve implements zzevn {
    ...
    public final /* bridge */ /* synthetic */ void zzj(Object obj) {
        ...
        bundle.putString("extra_caps", (String) zzba.zzc().zza(zzbbw.zzdq));
        bundle.putInt("target_api", this.zze);
        bundle.putInt("dv", this.zzf);
        bundle.putInt("lv", this.zzg);
        if (((Boolean) zzba.zzc().zza(zzbbw.zzfn)).booleanValue() && !TextUtils.isEmpty(this.zzh)) {
            bundle.putString("ev", this.zzh);
        }
        Bundle zza2 = zzffu.zza(bundle, "sdk_env");
        zza2.putBoolean("mf", ((Boolean) zzbds.zzc.zze()).booleanValue());
        ...
        Bundle zza3 = zzffu.zza(zza2, "build_meta");
        zza3.putString("cl", "661295874");
        zza3.putString("rapid_rc", PaymentConstants.ENVIRONMENT.DEV);
