...
public final class zzayq {
    ...
    public final Context zzb() {
        synchronized (this.zza) {
            ...
            Context zzb2 = zzayo.zzb();
            return zzb2;
        }
    }

    public final void zzc(zzayp zzayp) {
        synchronized (this.zza) {
            if (this.zzb == null) {
                this.zzb = new zzayo();
            }
    ...
    public final void zzd(android.content.Context r4) {
        ...
        L_0x0016:
            ...
            return
        L_0x001f:
            com.google.android.gms.internal.ads.zzayo r2 = r3.zzb     // Catch:{ all -> 0x0034 }
            if (r2 != 0) goto L_0x002a
            com.google.android.gms.internal.ads.zzayo r2 = new com.google.android.gms.internal.ads.zzayo     // Catch:{ all -> 0x0034 }
        ...
        L_0x0034:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzayq.zzd(android.content.Context):void");
    }

    public final void zze(zzayp zzayp) {
        synchronized (this.zza) {
            zzayo zzayo = this.zzb;
            if (zzayo != null) {
                zzayo.zzh(zzayp);
