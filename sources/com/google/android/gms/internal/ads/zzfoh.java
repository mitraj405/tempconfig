...
public final class zzfoh {
    ...
    public static zzfoh zza(Context context, Executor executor, boolean z) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        if (z) {
            executor.execute(new zzfof(context, taskCompletionSource));
        } else {
            executor.execute(new zzfog(taskCompletionSource));
        }
    ...
    private final Task zzh(int i, long j, Exception exc, String str, Map map, String str2) {
        if (!this.zze) {
            return this.zzd.continueWith(this.zzc, new zzfod());
        }
        ...
        return this.zzd.continueWith(this.zzc, new zzfoe(zza2, i));
    }
