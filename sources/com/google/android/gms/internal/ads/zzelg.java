...
public final class zzelg {
    ...
    private final synchronized zzfxu zzh(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            if (!TextUtils.isEmpty(zzu.zzo().zzi().zzh().zzc())) {
                boolean matches = Pattern.matches((String) zzba.zzc().zza(zzbbw.zzcP), str);
                boolean matches2 = Pattern.matches((String) zzba.zzc().zza(zzbbw.zzcQ), str);
                if (matches) {
                        ...
                        for (int i = 0; i < jSONArray.length(); i++) {
                            ...
                            if (!TextUtils.isEmpty(optString)) {
                                for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
                                    ...
                                    zzelk zzelk = new zzelk(optString, optBoolean2, optBoolean, optBoolean3, new Bundle());
                                    if (optString2.equals("ADMOB")) {
                                        this.zzd.put(optString, zzelk);
                                    } else if (optString2.equals("AD_MANAGER")) {
                                        this.zze.put(optString, zzelk);
                                    }
                                }
                            }
                        }
    ...
    private final synchronized void zzn() {
        if (!((Boolean) zzbdy.zzf.zze()).booleanValue()) {
            if (((Boolean) zzba.zzc().zza(zzbbw.zzbB)).booleanValue()) {
                JSONObject zzf2 = zzu.zzo().zzi().zzh().zzf();
                if (zzf2 != null) {
                    try {
    ...
    public final synchronized Map zza(String str, String str2) {
        ...
        zzfxu zzh = zzh(str2);
        hashMap = new HashMap();
        for (Map.Entry entry : ((zzfxu) zzb2).entrySet()) {
            String str3 = (String) entry.getKey();
            if (zzh.containsKey(str3)) {
                zzelk zzelk = (zzelk) zzh.get(str3);
                List list = (List) entry.getValue();
                boolean z = zzelk.zzb;
                boolean z2 = zzelk.zzc;
                boolean z3 = zzelk.zzd;
        ...
        zzfzx zze2 = zzh.entrySet().iterator();
        while (zze2.hasNext()) {
    ...
    public final synchronized java.util.Map zzb(java.lang.String r4, java.lang.String r5) {
        /*
            ...
            if (r0 != 0) goto L_0x0094
            com.google.android.gms.internal.ads.zzbze r0 = com.google.android.gms.ads.internal.zzu.zzo()     // Catch:{ all -> 0x009a }
            com.google.android.gms.ads.internal.util.zzg r0 = r0.zzi()     // Catch:{ all -> 0x009a }
            com.google.android.gms.internal.ads.zzbyy r0 = r0.zzh()     // Catch:{ all -> 0x009a }
        ...
        L_0x0024:
            ...
            java.lang.String r4 = com.google.android.gms.internal.ads.zzdqi.zza(r1, r5, r4)     // Catch:{ all -> 0x009a }
            com.google.android.gms.internal.ads.zzbbn r5 = com.google.android.gms.internal.ads.zzbbw.zzjW     // Catch:{ all -> 0x009a }
            com.google.android.gms.internal.ads.zzbbu r1 = com.google.android.gms.ads.internal.client.zzba.zzc()     // Catch:{ all -> 0x009a }
        ...
        L_0x0066:
            ...
            com.google.android.gms.internal.ads.zzeli r0 = (com.google.android.gms.internal.ads.zzeli) r0     // Catch:{ all -> 0x009a }
        ...
        L_0x0082:
            ...
            goto L_0x0066
        L_0x008e:
            com.google.android.gms.internal.ads.zzfxu r4 = com.google.android.gms.internal.ads.zzfxu.zzc(r4)     // Catch:{ all -> 0x009a }
            monitor-exit(r3)
            return r4
        L_0x0094:
            com.google.android.gms.internal.ads.zzfxu r4 = com.google.android.gms.internal.ads.zzfxu.zzd()     // Catch:{ all -> 0x009a }
            monitor-exit(r3)
            return r4
        L_0x009a:
            r4 = move-exception
    ...
    public final void zze() {
        zzu.zzo().zzi().zzr(new zzelf(this));
    ...
    public final synchronized void zzg(java.lang.String r5) {
        ...
        L_0x0008:
            ...
            java.util.Map r0 = r4.zza     // Catch:{ all -> 0x0025 }
            com.google.android.gms.internal.ads.zzeli r1 = new com.google.android.gms.internal.ads.zzeli     // Catch:{ all -> 0x0025 }
        ...
        L_0x0025:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzelg.zzg(java.lang.String):void");
    }
}
