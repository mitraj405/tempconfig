...
public final class zzyn implements zzyj, zzgu {
    ...
    public /* synthetic */ zzyn(Context context, Map map, int i, zzdj zzdj, boolean z, zzym zzym) {
            ...
            if (zzg == null) {
                ...
                if (!(context == null || (telephonyManager = (TelephonyManager) context.getSystemService("phone")) == null)) {
                    ...
                    if (!TextUtils.isEmpty(networkCountryIso)) {
                        str = zzfuf.zzb(networkCountryIso);
                        int[] zzm2 = zzm(str);
                        HashMap hashMap = new HashMap(8);
                        hashMap.put(0, 1000000L);
                        zzfxr zzfxr = zza;
                        hashMap.put(2, (Long) zzfxr.get(zzm2[0]));
                        ...
                        hashMap.put(7, (Long) zzfxr.get(zzm2[0]));
                        zzg = new zzyn(context2, hashMap, 2000, zzdj.zza, true, (zzym) null);
                    }
                }
                str = zzfuf.zzb(Locale.getDefault().getCountry());
                int[] zzm22 = zzm(str);
                HashMap hashMap2 = new HashMap(8);
                hashMap2.put(0, 1000000L);
                zzfxr zzfxr2 = zza;
                hashMap2.put(2, (Long) zzfxr2.get(zzm22[0]));
                ...
                hashMap2.put(7, (Long) zzfxr2.get(zzm22[0]));
                zzg = new zzyn(context2, hashMap2, 2000, zzdj.zza, true, (zzym) null);
            }
            zzyn = zzg;
        }
        return zzyn;
    ...
    public final synchronized void zzk(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.zzr     // Catch:{ all -> 0x0042 }
            if (r0 != r9) goto L_0x0006
            goto L_0x0040
        L_0x0006:
            r8.zzr = r9     // Catch:{ all -> 0x0042 }
            r0 = 1
            ...
            int r9 = r8.zzk     // Catch:{ all -> 0x0042 }
            if (r9 <= 0) goto L_0x0025
            long r2 = r8.zzl     // Catch:{ all -> 0x0042 }
            long r2 = r0 - r2
        ...
        L_0x0026:
            r3 = r9
            long r4 = r8.zzm     // Catch:{ all -> 0x0042 }
            long r6 = r8.zzp     // Catch:{ all -> 0x0042 }
            r2 = r8
            r2.zzj(r3, r4, r6)     // Catch:{ all -> 0x0042 }
            r8.zzl = r0     // Catch:{ all -> 0x0042 }
            r0 = 0
            r8.zzm = r0     // Catch:{ all -> 0x0042 }
            r8.zzo = r0     // Catch:{ all -> 0x0042 }
            r8.zzn = r0     // Catch:{ all -> 0x0042 }
            com.google.android.gms.internal.ads.zzzc r9 = r8.zzj     // Catch:{ all -> 0x0042 }
        ...
        L_0x0042:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzyn.zzk(int):void");
    }

    private static boolean zzl(zzfy zzfy, boolean z) {
        if (!z || zzfy.zzb(8)) {
            return false;
        }
        return true;
    ...
    public final synchronized void zza(zzfs zzfs, zzfy zzfy, boolean z, int i) {
        if (zzl(zzfy, z)) {
            this.zzm += (long) i;
        }
    }

    public final synchronized void zzb(zzfs zzfs, zzfy zzfy, boolean z) {
        boolean z2;
        if (zzl(zzfy, z)) {
            if (this.zzk > 0) {
                z2 = true;
    ...
    public final synchronized void zzd(zzfs zzfs, zzfy zzfy, boolean z) {
        if (zzl(zzfy, z)) {
            if (this.zzk == 0) {
    ...
    public final void zze(Handler handler, zzyi zzyi) {
        zzyi.getClass();
        this.zzi.zza(handler, zzyi);
    }

    public final void zzf(zzyi zzyi) {
        this.zzi.zzc(zzyi);
    }
