...
public final class zzgmg {
    ...
    public final synchronized void zzc(String str, zzgen zzgen) throws GeneralSecurityException {
        if (!this.zzb.containsKey(str)) {
            this.zzb.put(str, zzgen);
        } else if (!((zzgen) this.zzb.get(str)).equals(zzgen)) {
            String valueOf = String.valueOf(this.zzb.get(str));
            String valueOf2 = String.valueOf(zzgen);
