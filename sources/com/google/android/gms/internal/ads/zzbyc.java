...
public final class zzbyc {
    ...
    public static String zzb(Uri uri, Context context, Map map) {
        ...
        String str = (String) zzba.zzc().zza(zzbbw.zzZ);
        String uri2 = uri.toString();
        if (((Boolean) zzba.zzc().zza(zzbbw.zzY)).booleanValue() && uri2.contains(str)) {
            zzu.zzn().zzj(context, zza, (Map) map.get("_ac"));
            return zzd(uri2, context).replace(str, zza);
        } else if (!TextUtils.isEmpty(uri.getQueryParameter("fbs_aeid"))) {
            return uri2;
        } else {
            if (((Boolean) zzba.zzc().zza(zzbbw.zzX)).booleanValue()) {
                return uri2;
            }
    ...
    public static String zzc(String str, Context context, boolean z, Map map) {
        String zza;
        if ((((Boolean) zzba.zzc().zza(zzbbw.zzag)).booleanValue() && !z) || !zzu.zzn().zzp(context) || TextUtils.isEmpty(str) || (zza = zzu.zzn().zza(context)) == null) {
            return str;
        }
        String str2 = (String) zzba.zzc().zza(zzbbw.zzZ);
        if (!((Boolean) zzba.zzc().zza(zzbbw.zzY)).booleanValue() || !str.contains(str2)) {
