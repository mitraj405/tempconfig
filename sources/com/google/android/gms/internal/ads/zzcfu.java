...
public final class zzcfu {
    ...
    public static String zza(zzfel zzfel) {
        zzeek zzeek;
        if (((Boolean) zzba.zzc().zza(zzbbw.zzeC)).booleanValue() && zzfel.zzT && zzfel.zzV.zzb() && zzfel.zzb != 4) {
            if (zzfel.zzV.zzc() == 1) {
                zzeek = zzeek.VIDEO;
            } else {
                zzeek = zzeek.HTML_DISPLAY;
            }
            String str = zzfel.zzal;
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("creativeType", zzeek.toString());
