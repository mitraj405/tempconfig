...
public final /* synthetic */ class zzebb implements zzgbq {
    public final ListenableFuture zza(Object obj) {
        zzebl zzebl = (zzebl) obj;
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("response", zzebl.zza);
            JSONObject jSONObject2 = new JSONObject();
            for (String str : zzebl.zzb.keySet()) {
                if (str != null) {
                    JSONArray jSONArray = new JSONArray();
                    for (String str2 : (List) zzebl.zzb.get(str)) {
                        if (str2 != null) {
                            jSONArray.put(str2);
                        }
                    }
            ...
            String str3 = zzebl.zzc;
            if (str3 != null) {
                jSONObject.put("body", str3);
            }
            jSONObject.put("latency", zzebl.zzd);
