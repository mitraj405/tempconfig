...
final class zzp implements ServiceConnection {
    ...
    public final synchronized void zzf() {
        /*
            ...
            java.util.Queue r0 = r2.zzd     // Catch:{ all -> 0x0030 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x0030 }
            if (r0 == 0) goto L_0x002e
            android.util.SparseArray r0 = r2.zze     // Catch:{ all -> 0x0030 }
            ...
            com.google.android.gms.cloudmessaging.zzv r0 = r2.zzf     // Catch:{ all -> 0x0030 }
            com.google.android.gms.common.stats.ConnectionTracker r1 = com.google.android.gms.common.stats.ConnectionTracker.getInstance()     // Catch:{ all -> 0x0030 }
            android.content.Context r0 = r0.zzb     // Catch:{ all -> 0x0030 }
            r1.unbindService(r0, r2)     // Catch:{ all -> 0x0030 }
            monitor-exit(r2)
            return
        L_0x002e:
            monitor-exit(r2)
