...
public final class zzt extends zzbt {
    ...
    /* access modifiers changed from: private */
    public final Future zzc = zzbzo.zza.zzb(new zzp(this));
    /* access modifiers changed from: private */
    ...
    public static /* bridge */ /* synthetic */ String zzo(zzt zzt, String str) {
        if (zzt.zzh == null) {
            return str;
        }
    ...
    public static /* bridge */ /* synthetic */ void zzw(zzt zzt, String str) {
    ...
    public final String zzp() {
        ...
        zzauo zzauo = this.zzh;
        if (zzauo != null) {
            try {
                build = zzauo.zzb(build, this.zzd);
            } catch (zzaup e) {
                zzm.zzk("Unable to process ad data", e);
            }
        }
        return xx.D(zzq(), "#", build.getEncodedQuery());
    }
    ...
    public final String zzq() {
        ...
        return lf.j("https://", zzb2, (String) zzbde.zzd.zze());
    }
