...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    private void updateTextViews(int i) {
        ...
        for (int i2 = 0; i2 < Math.max(this.values.length, size); i2++) {
            ...
            if (i2 >= this.values.length) {
                ...
                f.o(textView, this.valueAccessibilityDelegate);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        new AccessibilityNodeInfoCompat(accessibilityNodeInfo).k(AccessibilityNodeInfoCompat.d.a(1, this.values.length, 1, false));
    }
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet, int i) {
        ...
        int defaultColor = d7.c(context, R.color.material_timepicker_clockface).getDefaultColor();
        ...
        this.valueAccessibilityDelegate = new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (intValue > 0) {
                    accessibilityNodeInfoCompat.f1832a.setTraversalAfter((View) ClockFaceView.this.textViewPool.get(intValue - 1));
                }
                accessibilityNodeInfoCompat.l(AccessibilityNodeInfoCompat.e.a(0, 1, intValue, 1, false, view.isSelected()));
                accessibilityNodeInfoCompat.f1832a.setClickable(true);
