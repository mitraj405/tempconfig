...
final class ColorResourcesTableCreator {
    ...
    private static final PackageInfo ANDROID_PACKAGE_INFO = new PackageInfo(1, LogSubCategory.LifeCycle.ANDROID);
    ...
    public static class ColorResource {
        ...
        public ColorResource(int i, String str, int i2) {
            ...
            this.typeId = (byte) ((i >> 16) & Constants.MAX_HOST_LENGTH);
            this.packageId = (byte) ((i >> 24) & Constants.MAX_HOST_LENGTH);
        }
    }
    ...
    public static byte[] charToByteArray(char c) {
        return new byte[]{(byte) (c & 255), (byte) ((c >> 8) & Constants.MAX_HOST_LENGTH)};
    }
