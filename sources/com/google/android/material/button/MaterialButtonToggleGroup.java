...
public class MaterialButtonToggleGroup extends LinearLayout {
        ...
        if (view instanceof MaterialButton) {
            ...
            f.o(materialButton, new AccessibilityDelegateCompat() {
                public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    ...
                    accessibilityNodeInfoCompat.l(AccessibilityNodeInfoCompat.e.a(0, 1, MaterialButtonToggleGroup.this.getIndexWithinVisibleButtons(view), 1, false, ((MaterialButton) view).isChecked()));
                }
            });
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfoCompat.k(AccessibilityNodeInfoCompat.d.a(1, visibleButtonCount, i, false));
    }
