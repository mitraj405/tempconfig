...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public void setBackgroundDrawable(Drawable drawable) {
            if (!(drawable == null || this.backgroundTint == null)) {
                ...
                v9.a.h(drawable, this.backgroundTint);
                v9.a.i(drawable, this.backgroundTintMode);
            }
        ...
        public void setBackgroundTintList(ColorStateList colorStateList) {
            ...
            if (getBackground() != null) {
                ...
                v9.a.h(mutate, colorStateList);
                v9.a.i(mutate, this.backgroundTintMode);
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(i)) {
                WeakHashMap<View, GC> weakHashMap = f.f1839a;
                f.d.s(this, (float) obtainStyledAttributes.getDimensionPixelSize(i, 0));
            }
    ...
    private boolean isSwipeDismissable() {
        ViewGroup.LayoutParams layoutParams = this.view.getLayoutParams();
        if (!(layoutParams instanceof CoordinatorLayout.LayoutParams) || !(((CoordinatorLayout.LayoutParams) layoutParams).f1713a instanceof SwipeDismissBehavior)) {
            return false;
        }
        return true;
    }
    ...
    public BaseTransientBottomBar(Context context2, ViewGroup viewGroup, View view2, ContentViewCallback contentViewCallback2) {
        ...
        this.bottomMarginGestureInsetRunnable = new Runnable() {
            public void run() {
                ...
                if (baseTransientBottomBar.view != null && baseTransientBottomBar.context != null) {
                    ...
                    if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
                        String unused2 = BaseTransientBottomBar.TAG;
                        return;
                    }
                    BaseTransientBottomBar baseTransientBottomBar3 = BaseTransientBottomBar.this;
                    int unused3 = baseTransientBottomBar3.appliedBottomMarginGestureInset = baseTransientBottomBar3.extraBottomMarginGestureInset;
                    ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
        ...
        if (viewGroup == null) {
            ...
            f.d.u(snackbarBaseLayout, new OnApplyWindowInsetsListener() {
                public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                    int unused = BaseTransientBottomBar.this.extraBottomMarginWindowInset = windowInsetsCompat.b();
                    int unused2 = BaseTransientBottomBar.this.extraLeftMarginWindowInset = windowInsetsCompat.c();
                    int unused3 = BaseTransientBottomBar.this.extraRightMarginWindowInset = windowInsetsCompat.d();
                    BaseTransientBottomBar.this.updateMargins();
                    return windowInsetsCompat;
                }
            });
            f.o(snackbarBaseLayout, new AccessibilityDelegateCompat() {
            ...
            this.animationSlideDuration = MotionUtils.resolveThemeDuration(context2, i, DEFAULT_SLIDE_ANIMATION_DURATION);
    ...
    public B setAnchorView(int i) {
        ...
        throw new IllegalArgumentException(lf.h("Unable to find anchor view with id: ", i));
    }
