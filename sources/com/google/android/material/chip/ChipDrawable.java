...
public class ChipDrawable extends MaterialShapeDrawable implements Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private int alpha = Constants.MAX_HOST_LENGTH;
    ...
    private void applyChildDrawable(Drawable drawable) {
        if (drawable != null) {
            ...
            if (drawable == this.closeIcon) {
                ...
                v9.a.h(drawable, this.closeIconTint);
                return;
            }
            Drawable drawable2 = this.chipIcon;
            if (drawable == drawable2 && this.hasChipIconTint) {
                v9.a.h(drawable2, this.chipIconTint);
            }
            if (drawable.isStateful()) {
    ...
    private void drawDebug(Canvas canvas, Rect rect) {
        ...
        if (paint != null) {
            paint.setColor(A5.d(-16777216, 127));
            ...
            this.debugPaint.setColor(A5.d(-65536, 127));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(A5.d(-16711936, 127));
    ...
    public boolean onLayoutDirectionChanged(int i) {
        ...
        if (showsChipIcon()) {
            onLayoutDirectionChanged |= v9.b.b(this.chipIcon, i);
        }
        if (showsCheckedIcon()) {
            onLayoutDirectionChanged |= v9.b.b(this.checkedIcon, i);
        }
        if (showsCloseIcon()) {
            onLayoutDirectionChanged |= v9.b.b(this.closeIcon, i);
        }
    ...
    public void setCheckedIconResource(int i) {
        setCheckedIcon(r1.w(this.context, i));
    }
    ...
    public void setCheckedIconTint(ColorStateList colorStateList) {
        if (this.checkedIconTint != colorStateList) {
            ...
            if (canShowCheckedIcon()) {
                v9.a.h(this.checkedIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setCheckedIconTintResource(int i) {
        setCheckedIconTint(d7.c(this.context, i));
    }
    ...
    public void setChipBackgroundColorResource(int i) {
        setChipBackgroundColor(d7.c(this.context, i));
    }
    ...
    public void setChipIconResource(int i) {
        setChipIcon(r1.w(this.context, i));
    }
    ...
    public void setChipIconTint(ColorStateList colorStateList) {
        ...
        if (this.chipIconTint != colorStateList) {
            ...
            if (showsChipIcon()) {
                v9.a.h(this.chipIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setChipIconTintResource(int i) {
        setChipIconTint(d7.c(this.context, i));
    }
    ...
    public void setChipStrokeColorResource(int i) {
        setChipStrokeColor(d7.c(this.context, i));
    }
    ...
    public void setCloseIconContentDescription(CharSequence charSequence) {
        ...
        if (this.closeIconContentDescription != charSequence) {
            ...
            this.closeIconContentDescription = k2.c(charSequence, k2.f327a);
            invalidateSelf();
        }
    }
    ...
    public void setCloseIconResource(int i) {
        setCloseIcon(r1.w(this.context, i));
    }
    ...
    public void setCloseIconTint(ColorStateList colorStateList) {
        if (this.closeIconTint != colorStateList) {
            ...
            if (showsCloseIcon()) {
                v9.a.h(this.closeIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
    ...
    public void setCloseIconTintResource(int i) {
        setCloseIconTint(d7.c(this.context, i));
    }
    ...
    public void setRippleColorResource(int i) {
        setRippleColor(d7.c(this.context, i));
    }
