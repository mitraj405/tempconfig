...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.b {
    ...
    public class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues("paddingStart")) {
                ...
                propertyValuesHolder.setFloatValues(new float[]{(float) extendedFloatingActionButton.getPaddingStart(), (float) this.size.getPaddingStart()});
            ...
            if (currentMotionSpec.hasPropertyValues("paddingEnd")) {
                ...
                propertyValuesHolder2.setFloatValues(new float[]{(float) extendedFloatingActionButton2.getPaddingEnd(), (float) this.size.getPaddingEnd()});
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        private static boolean isBottomSheet(View view) {
            ...
            if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
                return ((CoordinatorLayout.LayoutParams) layoutParams).f1713a instanceof BottomSheetBehavior;
            }
            return false;
        }
        ...
        private boolean shouldUpdateVisibility(View view, ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            if ((this.autoHideEnabled || this.autoShrinkEnabled) && layoutParams.d == view.getId()) {
    ...
    public void performMotion(int i, final OnChangedCallback onChangedCallback) {
        ...
        if (i == 0) {
            ...
            throw new IllegalStateException(lf.h("Unknown strategy type: ", i));
        }
