...
public class MaterialResources {
    ...
    public static ColorStateList getColorStateList(Context context, TypedArray typedArray, int i) {
        int resourceId;
        ColorStateList c;
        if (!typedArray.hasValue(i) || (resourceId = typedArray.getResourceId(i, 0)) == 0 || (c = d7.c(context, resourceId)) == null) {
    ...
    public static Drawable getDrawable(Context context, TypedArray typedArray, int i) {
        int resourceId;
        Drawable w;
        if (!typedArray.hasValue(i) || (resourceId = typedArray.getResourceId(i, 0)) == 0 || (w = r1.w(context, resourceId)) == null) {
    ...
    public static ColorStateList getColorStateList(Context context, TintTypedArray tintTypedArray, int i) {
        int i2;
        ColorStateList c;
        if (!tintTypedArray.l(i) || (i2 = tintTypedArray.i(i, 0)) == 0 || (c = d7.c(context, i2)) == null) {
            return tintTypedArray.b(i);
        }
        return c;
    }
}
