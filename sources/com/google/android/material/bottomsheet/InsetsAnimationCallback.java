...
class InsetsAnimationCallback extends WindowInsetsAnimationCompat.a {
    ...
    public WindowInsetsCompat onProgress(WindowInsetsCompat windowInsetsCompat, List<WindowInsetsAnimationCompat> list) {
        ...
        while (true) {
            ...
            if ((next.a.c() & 8) != 0) {
                this.view.setTranslationY((float) AnimationUtils.lerp(this.startTranslationY, 0, next.a.b()));
                break;
            }
        }
