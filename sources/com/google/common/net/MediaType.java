...
public final class MediaType {
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb.append("; ");
            PARAMETER_JOINER.appendTo(sb, (Iterable<? extends Map.Entry<?, ?>>) Multimaps.transformValues(this.parameters, new Vk()).entries());
        }
        return sb.toString();
    }
    ...
    private Map<String, ImmutableMultiset<String>> parametersAsMap() {
        return Maps.transformValues(this.parameters.asMap(), new Uk());
    }
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException(C0709Uj.f(lf.f(str, 18), "Could not parse '", str, "'"), e);
        }
    }
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    ...
                    throw new IllegalStateException(xx.A(lf.f(str2, str.length() + 35), "Multiple charset values defined: ", str, ", ", str2));
                }
            }
