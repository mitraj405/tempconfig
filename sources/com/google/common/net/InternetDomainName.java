...
public final class InternetDomainName {
    ...
    public InternetDomainName(String str) {
        ...
        this.parts = copyOf;
        Preconditions.checkArgument(copyOf.size() > MAX_PARTS ? false : z2, "Domain has too many parts: '%s'", (Object) lowerCase);
    ...
    public InternetDomainName child(String str) {
        ...
        StringBuilder sb = new StringBuilder(lf.f(str3, lf.f(str2, 1)));
        sb.append(str2);
        sb.append(".");
        sb.append(str3);
