...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            long load642 = jArr[0] + LittleEndianByteArray.load64(bArr2, i7 + 40) + rotateRight2;
            ...
            if (i8 == i4) {
                ...
                long load643 = (jArr[0] * 9) + LittleEndianByteArray.load64(bArr2, i6 + 40) + (Long.rotateRight(load642 + jArr[1] + LittleEndianByteArray.load64(bArr2, i6 + 48), 42) * j4);
                ...
                weakHashLength32WithSeeds(bArr3, i6 + 32, rotateRight5 + jArr2[1], load643 + LittleEndianByteArray.load64(bArr2, i6 + 16), jArr2);
                long j7 = j4;
                return hashLength16(C0437ME.a(shiftMix(load643), K0, hashLength16(jArr[0], jArr2[0], j7), rotateRight4), hashLength16(jArr[1], jArr2[1], j7) + rotateRight5, j7);
            }
            i7 = i8;
            shiftMix = j3;
            j2 = load642;
