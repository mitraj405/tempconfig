...
public abstract class CharSource {
    ...
    public final class AsByteSource extends ByteSource {
        ...
        public InputStream openStream() throws IOException {
            return new ReaderInputStream(CharSource.this.openStream(), this.charset, (int) UserMetadata.MAX_INTERNAL_KEY_SIZE);
        }

        public String toString() {
            String obj = CharSource.this.toString();
            String valueOf = String.valueOf(this.charset);
            return xx.A(valueOf.length() + lf.f(obj, 15), obj, ".asByteSource(", valueOf, ")");
        }
    }
    ...
    public static class CharSequenceCharSource extends CharSource {
        ...
        public String toString() {
            ...
            return C0709Uj.f(lf.f(truncate, 17), "CharSource.wrap(", truncate, ")");
        }
    ...
    public static final class ConcatenatedCharSource extends CharSource {
        ...
        public String toString() {
            ...
            return C0709Uj.f(valueOf.length() + 19, "CharSource.concat(", valueOf, ")");
        }
    }
