...
public final class Suppliers {
    ...
    public static class MemoizingSupplier<T> implements Supplier<T>, Serializable {
        ...
        public String toString() {
            ...
            if (this.initialized) {
                ...
                obj = C0709Uj.f(valueOf.length() + 25, "<supplier that returned ", valueOf, ">");
            } else {
                obj = this.delegate;
            }
            String valueOf2 = String.valueOf(obj);
            return C0709Uj.f(valueOf2.length() + 19, "Suppliers.memoize(", valueOf2, ")");
        }
    }
    ...
    public static class SupplierComposition<F, T> implements Supplier<T>, Serializable {
        ...
        public String toString() {
            ...
            StringBuilder I = xx.I(valueOf2.length() + valueOf.length() + 21, "Suppliers.compose(", valueOf, ", ", valueOf2);
            I.append(")");
            return I.toString();
        }
    }
    ...
    public static class SupplierOfInstance<T> implements Supplier<T>, Serializable {
        ...
        public String toString() {
            ...
            return C0709Uj.f(valueOf.length() + 22, "Suppliers.ofInstance(", valueOf, ")");
        }
    }
    ...
    public static class ThreadSafeSupplier<T> implements Supplier<T>, Serializable {
        ...
        public String toString() {
            String valueOf = String.valueOf(this.delegate);
            return C0709Uj.f(valueOf.length() + 32, "Suppliers.synchronizedSupplier(", valueOf, ")");
        }
    }
