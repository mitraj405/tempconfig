...
public final class MoreExecutors {
    ...
    public static class ListeningDecorator extends AbstractListeningExecutorService {
        ...
        public final String toString() {
            ...
            return xx.A(valueOf.length() + lf.f(obj, 2), obj, "[", valueOf, "]");
        }
    }
    ...
    public static class Application {
        public final void addDelayedShutdownHook(ExecutorService executorService, long j, TimeUnit timeUnit) {
            ...
            addShutdownHook(MoreExecutors.newThread(C1058d.v(valueOf.length() + 24, "DelayedShutdownHook-for-", valueOf), new Runnable(this) {
                public void run() {
                    try {
