    ...
    public final class QueueWorker implements Runnable {
        ...
        public String toString() {
            ...
            if (runnable != null) {
                ...
                return C0709Uj.f(valueOf.length() + 34, "SequentialExecutorWorker{running=", valueOf, "}");
            }
            String valueOf2 = String.valueOf(SequentialExecutor.this.workerRunningState);
            return C0709Uj.f(valueOf2.length() + 32, "SequentialExecutorWorker{state=", valueOf2, "}");
        }
    }
