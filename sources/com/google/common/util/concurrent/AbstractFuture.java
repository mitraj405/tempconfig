...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        public boolean casListeners(AbstractFuture<?> abstractFuture, Listener listener, Listener listener2) {
            return C0438NE.a(UNSAFE, abstractFuture, LISTENERS_OFFSET, listener, listener2);
        }

        public boolean casValue(AbstractFuture<?> abstractFuture, Object obj, Object obj2) {
            return C0438NE.a(UNSAFE, abstractFuture, VALUE_OFFSET, obj, obj2);
        }

        public boolean casWaiters(AbstractFuture<?> abstractFuture, Waiter waiter, Waiter waiter2) {
            return C0438NE.a(UNSAFE, abstractFuture, WAITERS_OFFSET, waiter, waiter2);
        }
    ...
    private void addPendingString(StringBuilder sb) {
        ...
        if (obj instanceof SetFuture) {
            ...
            try {
                ...
                str = C1058d.v(valueOf.length() + 38, "Exception thrown from implementation: ", valueOf);
            }
            if (str != null) {
                sb.append(", info=[");
                sb.append(str);
    ...
    public static Object getFutureValue(ListenableFuture<?> listenableFuture) {
        ...
        if (listenableFuture instanceof Trusted) {
            ...
            try {
                ...
                return new Cancellation(false, new IllegalArgumentException(C1058d.v(valueOf2.length() + 84, "get() did not throw CancellationException, despite reporting isCancelled() == true: ", valueOf2), e));
            } catch (CancellationException e2) {
                if (isCancelled) {
                    return new Cancellation(false, e2);
                }
                String valueOf3 = String.valueOf(listenableFuture);
                return new Failure(new IllegalArgumentException(C1058d.v(valueOf3.length() + 77, "get() threw CancellationException, despite reporting isCancelled() == false: ", valueOf3), e2));
            } catch (Throwable th) {
    ...
    public V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        if (!Thread.interrupted()) {
            ...
            StringBuilder sb = new StringBuilder(lf.f(lowerCase2, 28));
            sb.append("Waited ");
            sb.append(j2);
            sb.append(" ");
            ...
            if (nanos + SPIN_THRESHOLD_NANOS < 0) {
                ...
                if (i > 0) {
                    ...
                    StringBuilder sb3 = new StringBuilder(lf.f(lowerCase, valueOf.length() + 21));
                    sb3.append(valueOf);
                    sb3.append(convert);
                    sb3.append(" ");
            ...
            throw new TimeoutException(C0709Uj.f(lf.f(abstractFuture, lf.f(sb2, 5)), sb2, " for ", abstractFuture));
        }
        throw new InterruptedException();
    }
