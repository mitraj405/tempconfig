...
public class JsonReader implements Closeable {
    ...
    private IOException syntaxError(String str) throws IOException {
        ...
        J.append(locationString());
        throw new MalformedJsonException(J.toString());
    }
    ...
    public String locationString() {
        StringBuilder C = C1058d.C(" at line ", this.lineNumber + 1, " column ", (this.pos - this.lineStart) + 1, " path ");
        C.append(getPath());
        return C.toString();
    }
