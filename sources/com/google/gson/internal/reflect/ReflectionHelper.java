...
public class ReflectionHelper {
    ...
    public static class RecordSupportedHelper extends RecordHelper {
        ...
        private RecordSupportedHelper() throws NoSuchMethodException {
            ...
            this.isRecord = cls.getMethod("isRecord", new Class[0]);
    ...
    public static void makeAccessible(AccessibleObject accessibleObject) throws JsonIOException {
        try {
            ...
            throw new JsonIOException(lf.j("Failed making ", getAccessibleObjectDescription(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type."), e);
        }
    }
