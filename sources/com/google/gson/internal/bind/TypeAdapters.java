    ...
    public static final TypeAdapter<BigDecimal> BIG_DECIMAL = new TypeAdapter<BigDecimal>() {
        public BigDecimal read(JsonReader jsonReader) throws IOException {
            ...
            try {
                ...
                StringBuilder K = xx.K("Failed parsing '", nextString, "' as BigDecimal; at path ");
    ...
    public static final TypeAdapter<BigInteger> BIG_INTEGER = new TypeAdapter<BigInteger>() {
        public BigInteger read(JsonReader jsonReader) throws IOException {
            ...
            try {
                ...
                StringBuilder K = xx.K("Failed parsing '", nextString, "' as BigInteger; at path ");
                K.append(jsonReader.getPreviousPath());
                throw new JsonSyntaxException(K.toString(), e);
            }
        }
    ...
    static {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    ...
                    if (i2 == 1 || i2 == 2) {
                        ...
                        if (nextInt == 0) {
                            ...
                            StringBuilder m = lf.m("Invalid bitset value ", nextInt, ", expected 0 or 1; at path ");
        ...
        AnonymousClass5 r02 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder m = lf.m("Lossy conversion from ", nextInt, " to byte; at path ");
                    m.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(m.toString());
                } catch (NumberFormatException e) {
                    throw new JsonSyntaxException((Throwable) e);
        ...
        AnonymousClass6 r03 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder m = lf.m("Lossy conversion from ", nextInt, " to short; at path ");
                    m.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(m.toString());
                } catch (NumberFormatException e) {
                    throw new JsonSyntaxException((Throwable) e);
        ...
        AnonymousClass14 r05 = new TypeAdapter<Character>() {
            public Character read(JsonReader jsonReader) throws IOException {
                ...
                StringBuilder K = xx.K("Expecting character, got: ", nextString, "; at ");
                K.append(jsonReader.getPreviousPath());
        ...
        AnonymousClass24 r012 = new TypeAdapter<UUID>() {
            public UUID read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder K = xx.K("Failed parsing '", nextString, "' as UUID; at path ");
                    K.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(K.toString(), e);
                }
            }
        ...
        TypeAdapter<Currency> nullSafe6 = new TypeAdapter<Currency>() {
            public Currency read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder K = xx.K("Failed parsing '", nextString, "' as Currency; at path ");
                    K.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(K.toString(), e);
                }
            }
