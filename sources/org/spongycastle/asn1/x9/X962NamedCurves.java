    ...
    static {
        AnonymousClass1 r0 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.a("03188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012")), bigInteger, valueOf, Hex.a("3045AE6FC8422f64ED579528D38120EAE12196D5"));
            }
        };
        AnonymousClass2 r1 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.a("03eea2bae7e1497842f2de7769cfe9c989c072ad696f48034a")), bigInteger, valueOf, Hex.a("31a92ee2029fd10d901b113e990710f0d21ac6b6"));
            }
        };
        AnonymousClass3 r2 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.a("027d29778100c65a1da1783716588dce2b8b4aee8e228f1896")), bigInteger, valueOf, Hex.a("c469684435deb378c4b65ca9591e2a5763059a2e"));
            }
        };
        AnonymousClass4 r3 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.a("020ffa963cdca8816ccc33b8642bedf905c3d358573d3f27fbbd3b3cb9aaaf")), bigInteger, valueOf, Hex.a("e43bb460f0b80cc0c0b075798e948060f8321b7d"));
            }
        };
        AnonymousClass5 r4 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.a("0238af09d98727705120c921bb5e9e26296a3cdcf2f35757a0eafd87b830e7")), bigInteger, valueOf, Hex.a("e8b4011604095303ca3b8099982be09fcb9ae616"));
            }
        };
        AnonymousClass6 r5 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.a("036768ae8e18bb92cfcf005c949aa2c6d94853d0e660bbf854b1c9505fe95a")), bigInteger, valueOf, Hex.a("7d7374168ffe3471b60a857686a19475d3bfa2ff"));
            }
        };
        AnonymousClass7 r6 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) fp, new X9ECPoint((ECCurve) fp, Hex.a("036b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296")), bigInteger, valueOf, Hex.a("c49d360886e704936a6678e1139d26b7819f7e90"));
            }
        };
        AnonymousClass8 r7 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("0307AF69989546103D79329FCC3D74880F33BBE803CB")), bigInteger, valueOf, Hex.a("D2C0FB15760860DEF1EEF4D696E6768756151754"));
            }
        };
        AnonymousClass9 r8 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("030024266E4EB5106D0A964D92C4860E2671DB9B6CC5")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass10 r9 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("0202F9F87B7C574D0BDECF8A22E6524775F98CDEBDCB")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass11 r10 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("038D16C2866798B600F9F08BB4A8E860F3298CE04A5798")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass12 r11 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("0236B3DAF8A23206F9C4F299D7B21A9C369137F2C84AE1AA0D")), bigInteger, valueOf, Hex.a("4E13CA542744D696E67687561517552F279A8C84"));
            }
        };
        AnonymousClass13 r12 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("023809B2B7CC1B28CC5A87926AAD83FD28789E81E2C9E3BF10")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass14 r13 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("03375D4CE24FDE434489DE8746E71786015009E66E38A926DD")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass15 r14 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("0289FDFBE4ABE193DF9559ECF07AC0CE78554E2784EB8C1ED1A57A")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass16 r16 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("0257927098FA932E7C0A96D3FD5B706EF7E5F5C156E16B7E7C86038552E91D")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass17 r17 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("0228F9D04E900069C8DC47A08534FE76D2B900B7D7EF31F5709F200C4CA205")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass18 r18 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("0370F6E9D04D289C4E89913CE3530BFDE903977D42B146D539BF1BDE4E9C92")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass19 r19 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("026108BABB2CEEBCF787058A056CBE0CFE622D7723A289E08A07AE13EF0D10D171DD8D")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass20 r20 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("02197B07845E9BE2D96ADB0F5F3C7F2CFFBD7A3EB8B6FEC35C7FD67F26DDF6285A644F740A2614")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass21 r21 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("033C258EF3047767E7EDE0F1FDAA79DAEE3841366A132E163ACED4ED2401DF9C6BDCDE98E8E707C07A2239B1B097")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass22 r22 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("021085E2755381DCCCE3C1557AFA10C2F0C0C2825646C5B34A394CBCFA8BC16B22E7E789E927BE216F02E1FB136A5F")), bigInteger, valueOf, (byte[]) null);
            }
        };
        AnonymousClass23 r15 = new X9ECParametersHolder() {
            public final X9ECParameters a() {
                ...
                return new X9ECParameters((ECCurve) f2m, new X9ECPoint((ECCurve) f2m, Hex.a("02120FC05D3C67A99DE161D2F4092622FECA701BE4F50F4758714E8A87BBF2A658EF8C21E7C5EFE965361F6C2999C0C247B0DBD70CE6B7")), bigInteger, valueOf, (byte[]) null);
            }
        };
        a("prime192v1", X9ObjectIdentifiers.M0, r0);
        a("prime192v2", X9ObjectIdentifiers.N0, r1);
        a("prime192v3", X9ObjectIdentifiers.O0, r2);
        a("prime239v1", X9ObjectIdentifiers.P0, r3);
        a("prime239v2", X9ObjectIdentifiers.Q0, r4);
        a("prime239v3", X9ObjectIdentifiers.R0, r5);
        a("prime256v1", X9ObjectIdentifiers.S0, r6);
        a("c2pnb163v1", X9ObjectIdentifiers.w0, r7);
        a("c2pnb163v2", X9ObjectIdentifiers.x0, r8);
        a("c2pnb163v3", X9ObjectIdentifiers.y0, r9);
        a("c2pnb176w1", X9ObjectIdentifiers.z0, r10);
        a("c2tnb191v1", X9ObjectIdentifiers.A0, r11);
        a("c2tnb191v2", X9ObjectIdentifiers.B0, r12);
        a("c2tnb191v3", X9ObjectIdentifiers.C0, r13);
        a("c2pnb208w1", X9ObjectIdentifiers.D0, r14);
        a("c2tnb239v1", X9ObjectIdentifiers.E0, r16);
        a("c2tnb239v2", X9ObjectIdentifiers.F0, r17);
        a("c2tnb239v3", X9ObjectIdentifiers.G0, r18);
        a("c2pnb272w1", X9ObjectIdentifiers.H0, r19);
        a("c2pnb304w1", X9ObjectIdentifiers.I0, r20);
        a("c2tnb359v1", X9ObjectIdentifiers.J0, r21);
        a("c2pnb368w1", X9ObjectIdentifiers.K0, r22);
        a("c2tnb431r1", X9ObjectIdentifiers.L0, r15);
    }
