...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    public final TBSCertList.CRLEntry f6490a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLEntryObject) {
            return this.f6490a.equals(((X509CRLEntryObject) obj).f6490a);
        }
    ...
    public final byte[] getExtensionValue(String str) {
        ...
        try {
            ...
            throw new IllegalStateException(C1058d.x(e, new StringBuilder("Exception encoding: ")));
        }
    }
    ...
    public final Date getRevocationDate() {
        return Time.h(this.f6490a.a.s(1)).g();
    }

    public final BigInteger getSerialNumber() {
        return this.f6490a.i().t();
    }

    public final boolean hasExtensions() {
        if (this.f6490a.g() != null) {
            return true;
        }
        return false;
    }
            ...
            if (i.hasMoreElements()) {
                ...
                while (i.hasMoreElements()) {
                    ...
                    if (aSN1OctetString != null) {
                        ...
                        stringBuffer.append(") ");
                        try {
                            if (aSN1ObjectIdentifier.equals(Extension.f1)) {
                                ...
                                stringBuffer.append(str);
                            } else if (aSN1ObjectIdentifier.equals(Extension.i1)) {
