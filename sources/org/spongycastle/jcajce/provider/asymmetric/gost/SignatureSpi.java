...
public class SignatureSpi extends java.security.SignatureSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
    ...
    public final GOST3411Digest f6451a = new GOST3411Digest();

    /* renamed from: a  reason: collision with other field name */
    public final GOST3410Signer f6452a = new GOST3410Signer();
    ...
    public final void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (publicKey instanceof ECPublicKey) {
            ...
            try {
                PublicKey g = BouncyCastleProvider.g(SubjectPublicKeyInfo.g(publicKey.getEncoded()));
                if (g instanceof ECPublicKey) {
                    cipherParameters = ECUtil.c(g);
                } else {
        ...
        this.f6451a.reset();
        this.f6452a.a(false, cipherParameters);
    }
    ...
    public final byte[] engineSign() throws SignatureException {
        GOST3411Digest gOST3411Digest = this.f6451a;
        gOST3411Digest.getClass();
        byte[] bArr = new byte[32];
        gOST3411Digest.c(0, bArr);
        try {
            byte[] bArr2 = new byte[64];
            BigInteger[] b = this.f6452a.b(bArr);
    ...
    public final boolean engineVerify(byte[] bArr) throws SignatureException {
        ...
        try {
            ...
            return this.f6452a.c(new BigInteger[]{new BigInteger(1, bArr3), bigInteger}[0], bigInteger, bArr2);
        } catch (Exception unused) {
    ...
    public final void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        ...
        GOST3410Signer gOST3410Signer = this.f6452a;
        if (secureRandom != null) {
            gOST3410Signer.a(true, new ParametersWithRandom(cipherParameters, secureRandom));
        } else {
            gOST3410Signer.a(true, cipherParameters);
        }
    }
}
