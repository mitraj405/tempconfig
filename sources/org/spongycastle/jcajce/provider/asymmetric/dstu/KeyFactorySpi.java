...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    public final PrivateKey a(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (aSN1ObjectIdentifier.equals(UAObjectIdentifiers.a) || aSN1ObjectIdentifier.equals(UAObjectIdentifiers.b)) {
    ...
    public final PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof ECPublicKeySpec) {
            return new BCDSTU4145PublicKey((ECPublicKeySpec) keySpec, BouncyCastleProvider.f6565a);
        }
