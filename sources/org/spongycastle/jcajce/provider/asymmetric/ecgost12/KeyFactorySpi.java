...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    public static boolean c(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        if (aSN1ObjectIdentifier.equals(RosstandartObjectIdentifiers.e) || aSN1ObjectIdentifier.equals(RosstandartObjectIdentifiers.f) || aSN1ObjectIdentifier.equals(RosstandartObjectIdentifiers.i) || aSN1ObjectIdentifier.equals(RosstandartObjectIdentifiers.j)) {
            return true;
        }
        return false;
    }
    ...
    public final PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof ECPublicKeySpec) {
            return new BCECGOST3410_2012PublicKey((ECPublicKeySpec) keySpec, BouncyCastleProvider.f6565a);
        }
