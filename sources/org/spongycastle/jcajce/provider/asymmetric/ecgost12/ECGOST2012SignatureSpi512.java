...
public class ECGOST2012SignatureSpi512 extends SignatureSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
    public final GOST3411_2012_512Digest a = new GOST3411_2012_512Digest();

    /* renamed from: a  reason: collision with other field name */
    public final ECGOST3410_2012Signer f6429a = new ECGOST3410_2012Signer();
    ...
    public final void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        if (privateKey instanceof ECKey) {
            ...
            ECGOST3410_2012Signer eCGOST3410_2012Signer = this.f6429a;
    ...
    public final void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        this.a.reset();
        this.f6429a.a(false, cipherParameters);
    }
    ...
    public final byte[] engineSign() throws SignatureException {
        int i = this.c;
        GOST3411_2012_512Digest gOST3411_2012_512Digest = this.a;
        gOST3411_2012_512Digest.getClass();
        byte[] bArr = new byte[64];
        gOST3411_2012_512Digest.c(0, bArr);
        try {
            byte[] bArr2 = new byte[i];
            BigInteger[] b = this.f6429a.b(bArr);
    ...
    public final boolean engineVerify(byte[] bArr) throws SignatureException {
        ...
        gOST3411_2012_512Digest.c(0, bArr2);
        try {
            ...
            return this.f6429a.c(new BigInteger[]{new BigInteger(1, bArr3), bigInteger}[0], bigInteger, bArr2);
        } catch (Exception unused) {
