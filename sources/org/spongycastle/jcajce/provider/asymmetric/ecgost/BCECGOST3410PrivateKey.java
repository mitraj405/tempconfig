...
public class BCECGOST3410PrivateKey implements ECPrivateKey, org.spongycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    public transient ECParameterSpec f6410a;

    /* renamed from: a  reason: collision with other field name */
    public transient ASN1Object f6411a;

    /* renamed from: a  reason: collision with other field name */
    public transient DERBitString f6412a;

    /* renamed from: a  reason: collision with other field name */
    public transient PKCS12BagAttributeCarrierImpl f6413a = new PKCS12BagAttributeCarrierImpl();
    public final String c = "ECGOST3410";
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        this.f6413a = new PKCS12BagAttributeCarrierImpl();
    }
    ...
    public final org.spongycastle.jce.spec.ECParameterSpec a() {
        ECParameterSpec eCParameterSpec = this.f6410a;
    ...
    public final void c(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (!z || !(ASN1Sequence.q(b).size() == 2 || ASN1Sequence.q(b).size() == 3)) {
            ...
            if (aSN1Primitive instanceof ASN1ObjectIdentifier) {
                ...
                if (g == null) {
                    ...
                    eCPoint.b();
                    this.f6410a = new ECNamedCurveSpec(b2, a2, new java.security.spec.ECPoint(eCPoint.f6621a.t(), eCPoint.e().t()), eCDomainParameters.g, eCDomainParameters.h);
                } else {
                    EllipticCurve a3 = EC5Util.a(g.f5787a);
                    String d = ECUtil.d(u);
                    ECPoint g2 = g.g();
                    g2.b();
                    this.f6410a = new ECNamedCurveSpec(d, a3, new java.security.spec.ECPoint(g2.f6621a.t(), g.g().e().t()), g.a, g.b);
                }
                ...
                ECPoint g3 = h.g();
                g3.b();
                this.f6410a = new ECParameterSpec(a4, new java.security.spec.ECPoint(g3.f6621a.t(), h.g().e().t()), h.a, h.b.intValue());
            }
        ...
        String b3 = ECGOST3410NamedCurves.b(g5.Z0);
        ECPoint eCPoint2 = a5.f6603a;
        eCPoint2.b();
        this.f6410a = new ECNamedCurveSpec(b3, a6, new java.security.spec.ECPoint(eCPoint2.f6621a.t(), eCPoint2.e().t()), a5.a, a5.b);
    ...
    public final ASN1Encodable d(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        return this.f6413a.d(aSN1ObjectIdentifier);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!this.a.equals(bCECGOST3410PrivateKey.a) || !b().equals(bCECGOST3410PrivateKey.b())) {
            return false;
        }
        return true;
    }
    ...
    public final void f(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Encodable aSN1Encodable) {
        this.f6413a.f(aSN1ObjectIdentifier, aSN1Encodable);
    }
    ...
    public final byte[] getEncoded() {
        ...
        if (this.f6411a != null) {
            ...
            try {
                return new PrivateKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.l, this.f6411a), new DEROctetString(bArr)).f("DER");
            ...
            if (eCParameterSpec instanceof ECNamedCurveSpec) {
                ...
                if (h == null) {
                    h = new ASN1ObjectIdentifier(((ECNamedCurveSpec) this.f6410a).a);
                }
                x962Parameters = new X962Parameters(h);
                i = ECUtil.i(BouncyCastleProvider.f6565a, this.f6410a.getOrder(), getS());
                ...
                x962Parameters = new X962Parameters(new X9ECParameters(b, EC5Util.d(b, this.f6410a.getGenerator()), this.f6410a.getOrder(), BigInteger.valueOf((long) this.f6410a.getCofactor()), this.f6410a.getCurve().getSeed()));
                i = ECUtil.i(BouncyCastleProvider.f6565a, this.f6410a.getOrder(), getS());
            }
            if (this.f6412a != null) {
                eCPrivateKey = new org.spongycastle.asn1.sec.ECPrivateKey(i, getS(), this.f6412a, x962Parameters);
            } else {
                eCPrivateKey = new org.spongycastle.asn1.sec.ECPrivateKey(i, getS(), (DERBitString) null, x962Parameters);
            }
            try {
                return new PrivateKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.l, x962Parameters.a), eCPrivateKey.a).f("DER");
    ...
    public BCECGOST3410PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        ...
        if (eCParameterSpec != null) {
            this.f6410a = EC5Util.e(EC5Util.a(eCParameterSpec.f6602a), eCParameterSpec);
        } else {
            this.f6410a = null;
        }
    }
    ...
    public BCECGOST3410PrivateKey(java.security.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        ...
        this.f6410a = eCPrivateKeySpec.getParams();
    }
    ...
    public BCECGOST3410PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECGOST3410PublicKey bCECGOST3410PublicKey, ECParameterSpec eCParameterSpec) {
        ...
        if (eCParameterSpec == null) {
            ...
            ECPoint eCPoint = eCDomainParameters.f6230a;
            eCPoint.b();
            this.f6410a = new ECParameterSpec(a2, new java.security.spec.ECPoint(eCPoint.f6621a.t(), eCPoint.e().t()), eCDomainParameters.g, eCDomainParameters.h.intValue());
        } else {
            this.f6410a = eCParameterSpec;
        }
        this.f6411a = bCECGOST3410PublicKey.f6414a;
        try {
            dERBitString = SubjectPublicKeyInfo.g(ASN1Primitive.k(bCECGOST3410PublicKey.getEncoded())).a;
        } catch (IOException unused) {
            dERBitString = null;
        }
        this.f6412a = dERBitString;
    }
    ...
    public BCECGOST3410PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECGOST3410PublicKey bCECGOST3410PublicKey, org.spongycastle.jce.spec.ECParameterSpec eCParameterSpec) {
        ...
        if (eCParameterSpec == null) {
            ...
            eCPoint2.b();
            this.f6410a = new ECParameterSpec(a3, new java.security.spec.ECPoint(eCPoint2.f6621a.t(), eCPoint2.e().t()), eCParameterSpec.a, eCParameterSpec.b.intValue());
        }
        this.f6411a = bCECGOST3410PublicKey.f6414a;
        try {
            dERBitString = SubjectPublicKeyInfo.g(ASN1Primitive.k(bCECGOST3410PublicKey.getEncoded())).a;
