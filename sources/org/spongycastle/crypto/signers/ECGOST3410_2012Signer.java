...
public class ECGOST3410_2012Signer implements DSA {
    ...
    public ECKeyParameters f6273a;

    public final void a(boolean z, CipherParameters cipherParameters) {
        if (!z) {
            this.f6273a = (ECPublicKeyParameters) cipherParameters;
        } else if (cipherParameters instanceof ParametersWithRandom) {
            ParametersWithRandom parametersWithRandom = (ParametersWithRandom) cipherParameters;
            this.a = parametersWithRandom.a;
            this.f6273a = (ECPrivateKeyParameters) parametersWithRandom.f6234a;
        } else {
            this.a = new SecureRandom();
            this.f6273a = (ECPrivateKeyParameters) cipherParameters;
        }
    }
    ...
    public final BigInteger[] b(byte[] bArr) {
        ...
        ECKeyParameters eCKeyParameters = this.f6273a;
    ...
    public final boolean c(BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        ...
        BigInteger bigInteger4 = this.f6273a.a.g;
