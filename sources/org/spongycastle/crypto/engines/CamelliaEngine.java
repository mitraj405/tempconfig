...
public class CamelliaEngine implements BlockCipher {
    ...
    public static void i(int i2, int i3, int i4, int[] iArr, int[] iArr2) {
        int i5 = i4 + 2;
        int i6 = i3 + 1;
        int i7 = i2 - 32;
        int i8 = i3 + 2;
    ...
    public static void k(int i2, int i3, int i4, int[] iArr, int[] iArr2) {
        int i5 = i4 + 0;
        int i6 = i3 + 0;
        int i7 = i3 + 1;
        int i8 = 32 - i2;
    ...
    public static void l(int i2, int i3, int i4, int[] iArr, int[] iArr2) {
        int i5 = i4 + 0;
        int i6 = i3 + 1;
        int i7 = i2 - 32;
        int i8 = i3 + 2;
    ...
    public final void a(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters2 instanceof KeyParameter) {
            ...
            f(iArr2, 4, iArr5);
            boolean z2 = this.b;
            int[] iArr6 = this.f5929b;
            int[] iArr7 = this.c;
            int[] iArr8 = this.f5928a;
            if (!z2) {
                ...
                if (z) {
                    ...
                    iArr6[2] = iArr[2];
                    iArr6[3] = iArr[3];
                    l(45, 0, 16, iArr, iArr8);
                    k(15, 0, 4, iArr, iArr7);
                    k(17, 0, 32, iArr, iArr8);
                    l(34, 0, 44, iArr, iArr8);
                    k(15, 4, 4, iArr, iArr8);
                    k(15, 4, 0, iArr, iArr7);
                    k(30, 4, 24, iArr, iArr8);
                    l(34, 4, 36, iArr, iArr8);
                    k(15, 0, 8, iArr2, iArr8);
                    k(30, 0, 20, iArr2, iArr8);
                    iArr7[8] = iArr2[1];
                    iArr7[9] = iArr2[2];
                    iArr7[10] = iArr2[3];
                    iArr7[11] = iArr2[0];
                    l(49, 0, 40, iArr2, iArr8);
                    iArr8[0] = iArr3[0];
                    iArr8[1] = iArr3[1];
                    iArr8[2] = iArr3[2];
                    iArr8[3] = iArr3[3];
                    k(30, 0, 12, iArr3, iArr8);
                    k(30, 0, 28, iArr3, iArr8);
                    l(51, 0, 4, iArr3, iArr6);
                } else {
                    iArr6[4] = iArr[0];
                    iArr6[5] = iArr[1];
                    iArr6[6] = iArr[2];
                ...
                iArr6[3] = iArr[3];
                k(15, 0, 4, iArr, iArr8);
                k(30, 0, 12, iArr, iArr8);
                k(15, 0, 0, iArr, iArr4);
                iArr8[18] = iArr4[2];
                iArr8[19] = iArr4[3];
                k(17, 0, 4, iArr, iArr7);
                k(17, 0, 24, iArr, iArr8);
                k(17, 0, 32, iArr, iArr8);
                iArr8[0] = iArr2[0];
                iArr8[1] = iArr2[1];
                iArr8[2] = iArr2[2];
                iArr8[3] = iArr2[3];
                k(15, 0, 8, iArr2, iArr8);
                k(15, 0, 0, iArr2, iArr7);
                k(15, 0, 0, iArr2, iArr4);
                iArr8[16] = iArr4[0];
                iArr8[17] = iArr4[1];
                k(15, 0, 20, iArr2, iArr8);
                l(34, 0, 28, iArr2, iArr8);
                k(17, 0, 4, iArr2, iArr6);
            } else {
                iArr6[4] = iArr[0];
                iArr6[5] = iArr[1];
                iArr6[6] = iArr[2];
    ...
    public final int e(int i2, int i3, byte[] bArr, byte[] bArr2) throws DataLengthException, IllegalStateException {
        ...
        if (!this.a) {
            ...
            boolean z = this.b;
            int[] iArr = this.c;
            int[] iArr2 = this.f5928a;
            int[] iArr3 = this.d;
            int[] iArr4 = this.f5929b;
            if (z) {
                for (int i5 = 0; i5 < 4; i5++) {
                    int d2 = d((i5 * 4) + i2, bArr3);
                    iArr3[i5] = d2;
                    iArr3[i5] = iArr4[i5] ^ d2;
                }
                f(iArr3, 0, iArr2);
                f(iArr3, 4, iArr2);
                f(iArr3, 8, iArr2);
                ...
                f(iArr3, 28, iArr2);
                f(iArr3, 32, iArr2);
                int i6 = iArr3[2] ^ iArr4[4];
                iArr3[2] = i6;
                iArr3[3] = iArr3[3] ^ iArr4[5];
                iArr3[0] = iArr3[0] ^ iArr4[6];
                iArr3[1] = iArr3[1] ^ iArr4[7];
                j(i6, bArr4, i4);
                j(iArr3[3], bArr4, i4 + 4);
                j(iArr3[0], bArr4, i4 + 8);
                j(iArr3[1], bArr4, i4 + 12);
                return 16;
            }
            for (int i7 = 0; i7 < 4; i7++) {
                int d3 = d((i7 * 4) + i2, bArr3);
                iArr3[i7] = d3;
                iArr3[i7] = iArr4[i7] ^ d3;
            }
            f(iArr3, 0, iArr2);
            f(iArr3, 4, iArr2);
            f(iArr3, 8, iArr2);
    ...
    public final void f(int[] iArr, int i2, int[] iArr2) {
        int i3 = iArr[0];
        int i4 = iArr2[i2 + 0] ^ i3;
        int[] iArr3 = g;
        int i5 = iArr3[i4 & Constants.MAX_HOST_LENGTH];
        int[] iArr4 = i;
        int i6 = i5 ^ iArr4[(i4 >>> 8) & Constants.MAX_HOST_LENGTH];
        int[] iArr5 = h;
        int i7 = i6 ^ iArr5[(i4 >>> 16) & Constants.MAX_HOST_LENGTH];
        int[] iArr6 = f;
        int i8 = iArr6[(i4 >>> 24) & Constants.MAX_HOST_LENGTH] ^ i7;
        int i9 = iArr[1];
        int i10 = iArr2[i2 + 1] ^ i9;
        int i11 = (iArr5[(i10 >>> 24) & Constants.MAX_HOST_LENGTH] ^ ((iArr6[i10 & Constants.MAX_HOST_LENGTH] ^ iArr3[(i10 >>> 8) & Constants.MAX_HOST_LENGTH]) ^ iArr4[(i10 >>> 16) & Constants.MAX_HOST_LENGTH])) ^ i8;
        int i12 = iArr[2] ^ i11;
        iArr[2] = i12;
        int i13 = (((i8 >>> 8) + (i8 << 24)) ^ i11) ^ iArr[3];
        iArr[3] = i13;
        int i14 = iArr2[i2 + 2] ^ i12;
        int i15 = iArr6[(i14 >>> 24) & Constants.MAX_HOST_LENGTH] ^ ((iArr3[i14 & Constants.MAX_HOST_LENGTH] ^ iArr4[(i14 >>> 8) & Constants.MAX_HOST_LENGTH]) ^ iArr5[(i14 >>> 16) & Constants.MAX_HOST_LENGTH]);
        int i16 = i13 ^ iArr2[i2 + 3];
        int i17 = iArr6[i16 & Constants.MAX_HOST_LENGTH];
        int i18 = (iArr5[(i16 >>> 24) & Constants.MAX_HOST_LENGTH] ^ ((iArr3[(i16 >>> 8) & Constants.MAX_HOST_LENGTH] ^ i17) ^ iArr4[(i16 >>> 16) & Constants.MAX_HOST_LENGTH])) ^ i15;
        iArr[0] = i3 ^ i18;
        iArr[1] = (((i15 >>> 8) + (i15 << 24)) ^ i18) ^ i9;
    }

    public final void g(int[] iArr, int i2, int[] iArr2) {
        int i3 = iArr[1];
        int i4 = iArr[0];
        int i5 = iArr2[i2 + 0] & i4;
        int i6 = i3 ^ ((i5 << 1) + (i5 >>> 31));
        iArr[1] = i6;
        iArr[0] = (iArr2[i2 + 1] | i6) ^ i4;
        int i7 = iArr[2];
        int i8 = iArr2[i2 + 3];
        int i9 = iArr[3];
        int i10 = i7 ^ (i8 | i9);
        iArr[2] = i10;
        int i11 = iArr2[i2 + 2] & i10;
        iArr[3] = ((i11 << 1) + (i11 >>> 31)) ^ i9;
    }
