...
public class SecT113R2Point extends ECPoint.AbstractF2m {
        ...
        if (!i) {
            ...
            if (!a2.i()) {
                if (eCFieldElement9.i()) {
                    ...
                    eCFieldElement5 = xx.N(d, d, eCFieldElement13).a(eCCurve.f6610a);
                    if (eCFieldElement5.i()) {
                        return new SecT113R2Point(eCCurve, eCFieldElement5, eCCurve.f6614b.n(), this.f6622a);
                    }
                    ...
                    if (j4.i()) {
                        return new SecT113R2Point(eCCurve, j4, eCCurve.f6614b.n(), this.f6622a);
                    }
                ...
                return new SecT113R2Point(eCCurve, eCFieldElement5, eCFieldElement4, new ECFieldElement[]{eCFieldElement6}, this.f6622a);
            } else if (a.i()) {
                return x();
            } else {
                return eCCurve.l();
    ...
    public final ECPoint c() {
        b();
        return new SecT113R2Point((ECCurve) null, this.f6621a, e(), false);
    }
    ...
    public final ECPoint n() {
        ...
        return new SecT113R2Point(this.f6620a, eCFieldElement, this.f6624b.a(eCFieldElement2), new ECFieldElement[]{eCFieldElement2}, this.f6622a);
    }
    ...
    public final ECPoint x() {
        ...
        ECFieldElement eCFieldElement7 = eCCurve.f6610a;
        if (!h) {
            eCFieldElement7 = eCFieldElement7.j(eCFieldElement2);
        }
        ECFieldElement N = xx.N(eCFieldElement6, eCFieldElement, eCFieldElement7);
        if (N.i()) {
            return new SecT113R2Point(eCCurve, N, eCCurve.f6614b.n(), this.f6622a);
        }
        ...
        return new SecT113R2Point(eCCurve, o, eCFieldElement4.p(N, eCFieldElement).a(o).a(eCFieldElement3), new ECFieldElement[]{eCFieldElement3}, this.f6622a);
    }
    ...
    public final ECPoint y(ECPoint eCPoint) {
        ...
        ECFieldElement j2 = eCFieldElement4.j(eCFieldElement3);
        ECCurve eCCurve = this.f6620a;
        ECFieldElement a = eCCurve.f6610a.j(o3).a(o2).a(j2);
        ECFieldElement b = eCPoint.f6624b.b();
        ECFieldElement l = eCCurve.f6610a.a(b).j(o3).a(o2).l(a, o, o3);
        ECFieldElement j3 = eCFieldElement2.j(o3);
        ECFieldElement o4 = j3.a(a).o();
        if (o4.i()) {
            if (l.i()) {
                return eCPoint.x();
            }
            ...
            return new SecT113R2Point(eCCurve, l, eCCurve.f6614b.n(), this.f6622a);
        } else {
            ECFieldElement j4 = l.o().j(j3);
            ECFieldElement j5 = l.j(o4).j(o3);
            return new SecT113R2Point(eCCurve, j4, l.a(o4).o().l(a, b, j5), new ECFieldElement[]{j5}, this.f6622a);
        }
    }
