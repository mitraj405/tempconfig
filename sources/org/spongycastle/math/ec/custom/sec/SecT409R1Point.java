...
public class SecT409R1Point extends ECPoint.AbstractF2m {
            ...
            if (!a2.i()) {
                if (eCFieldElement9.i()) {
                    ...
                    if (eCFieldElement5.i()) {
                        return new SecT409R1Point(eCCurve, eCFieldElement5, eCCurve.f6614b.n(), this.f6622a);
                    }
                    ...
                    if (j4.i()) {
                        return new SecT409R1Point(eCCurve, j4, eCCurve.f6614b.n(), this.f6622a);
                    }
                ...
                return new SecT409R1Point(eCCurve, eCFieldElement5, eCFieldElement4, new ECFieldElement[]{eCFieldElement6}, this.f6622a);
            } else if (a.i()) {
                return x();
            } else {
                return eCCurve.l();
    ...
    public final ECPoint c() {
        b();
        return new SecT409R1Point((ECCurve) null, this.f6621a, e(), false);
    }
    ...
    public final ECPoint n() {
        ...
        return new SecT409R1Point(this.f6620a, eCFieldElement, this.f6624b.a(eCFieldElement2), new ECFieldElement[]{eCFieldElement2}, this.f6622a);
    }
    ...
    public final ECPoint x() {
        ...
        if (N.i()) {
            return new SecT409R1Point(eCCurve, N, eCCurve.f6614b.n(), this.f6622a);
        }
        ...
        return new SecT409R1Point(eCCurve, o, eCFieldElement4.p(N, eCFieldElement).a(o).a(eCFieldElement3), new ECFieldElement[]{eCFieldElement3}, this.f6622a);
    }
    ...
    public final ECPoint y(ECPoint eCPoint) {
        ...
        if (o4.i()) {
            ...
            return new SecT409R1Point(eCCurve, l, eCCurve.f6614b.n(), this.f6622a);
        } else {
            ECFieldElement j3 = l.o().j(j2);
            ECFieldElement j4 = l.j(o4).j(o3);
            return new SecT409R1Point(eCCurve, j3, l.a(o4).o().l(a, eCFieldElement5.b(), j4), new ECFieldElement[]{j4}, this.f6622a);
        }
    }
