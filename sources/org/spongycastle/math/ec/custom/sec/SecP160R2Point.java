...
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public final org.spongycastle.math.ec.ECPoint a(org.spongycastle.math.ec.ECPoint r17) {
        ...
        L_0x00ff:
            ...
            r1 = 0
            r6[r1] = r2
            org.spongycastle.math.ec.custom.sec.SecP160R2Point r1 = new org.spongycastle.math.ec.custom.sec.SecP160R2Point
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.ec.custom.sec.SecP160R2Point.a(org.spongycastle.math.ec.ECPoint):org.spongycastle.math.ec.ECPoint");
    }

    public final ECPoint c() {
        b();
        return new SecP160R2Point((ECCurve) null, this.f6621a, e(), false);
    }
    ...
    public final ECPoint n() {
        ...
        return new SecP160R2Point(this.f6620a, this.f6621a, this.f6624b.m(), this.f6623a, this.f6622a);
    }
    ...
    public final ECPoint x() {
        ...
        int[] iArr3 = new int[5];
        int[] iArr4 = new int[5];
        int[] iArr5 = secP160R2FieldElement.a;
        SecP160R2Field.e(iArr5, iArr4);
        int[] iArr6 = new int[5];
        SecP160R2Field.e(iArr4, iArr6);
        boolean h = secP160R2FieldElement3.h();
        int[] iArr7 = secP160R2FieldElement3.a;
        if (!h) {
        ...
        SecP160R2Field.g(secP160R2FieldElement2.a, iArr, iArr2);
        int[] iArr8 = secP160R2FieldElement2.a;
        int a = Nat160.a(iArr8, iArr, iArr3);
        int[] iArr9 = SecP160R2Field.a;
        ...
        int[] iArr10 = secP160R2FieldElement4.a;
        SecP160R2Field.e(iArr3, iArr10);
        SecP160R2Field.g(iArr10, iArr4, iArr10);
        SecP160R2Field.g(iArr10, iArr4, iArr10);
        SecP160R2FieldElement secP160R2FieldElement5 = new SecP160R2FieldElement(iArr4);
        int[] iArr11 = secP160R2FieldElement5.a;
        SecP160R2Field.g(iArr4, iArr10, iArr11);
        SecP160R2Field.a(iArr11, iArr3, iArr11);
        SecP160R2Field.g(iArr11, iArr2, iArr11);
        SecP160R2FieldElement secP160R2FieldElement6 = new SecP160R2FieldElement(iArr3);
        int[] iArr12 = secP160R2FieldElement6.a;
        if (Nat.r(5, 0, iArr5, iArr12) != 0 || (iArr12[4] == -1 && Nat160.e(iArr12, iArr9))) {
            Nat.b(5, 21389, iArr12);
        }
        if (!h) {
            SecP160R2Field.a(iArr12, iArr7, iArr12);
        }
        return new SecP160R2Point(eCCurve, secP160R2FieldElement4, secP160R2FieldElement5, new ECFieldElement[]{secP160R2FieldElement6}, this.f6622a);
    }
