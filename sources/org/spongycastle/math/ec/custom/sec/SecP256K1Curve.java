...
public class SecP256K1Curve extends ECCurve.AbstractFp {
    public static final BigInteger c = new BigInteger(1, Hex.a("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F"));
    public final SecP256K1Point a = new SecP256K1Point(this, (ECFieldElement) null, (ECFieldElement) null, false);

    public SecP256K1Curve() {
        super(c);
        this.f6610a = new SecP256K1FieldElement(ECConstants.a);
        this.f6614b = new SecP256K1FieldElement(BigInteger.valueOf(7));
        this.f6609a = new BigInteger(1, Hex.a("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141"));
