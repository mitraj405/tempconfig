...
public class SecP192K1Curve extends ECCurve.AbstractFp {
    public static final BigInteger c = new BigInteger(1, Hex.a("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFEE37"));
    public final SecP192K1Point a = new SecP192K1Point(this, (ECFieldElement) null, (ECFieldElement) null, false);

    public SecP192K1Curve() {
        super(c);
        this.f6610a = new SecP192K1FieldElement(ECConstants.a);
        this.f6614b = new SecP192K1FieldElement(BigInteger.valueOf(3));
        this.f6609a = new BigInteger(1, Hex.a("FFFFFFFFFFFFFFFFFFFFFFFE26F2FC170F69466A74DEFD8D"));
